...
<p>The Default Property Example is a minor modification of the <a href="https://developer.ubuntu.comapps/qml/sdk-15.04.4/QtQml.referenceexamples-coercion/">Extending QML - Inheritance and Coercion Example</a> that simplifies the specification of a BirthdayParty through the use of a default property.</p>
