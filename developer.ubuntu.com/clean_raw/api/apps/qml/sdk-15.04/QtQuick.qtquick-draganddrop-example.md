...
<p class="centerAlign"><img src="https://developer.ubuntu.com/static/devportal_uploaded/9345ccf4-c602-4d11-9635-c87e5e833f80-../qtquick-draganddrop-example/images/qml-draganddrop-example.png" alt="" /></p><p><i>Drag and Drop</i> is a collection of small QML examples relating to drag and drop functionality. For more information, visit the Drag and Drop page.</p>
...
<p><i>GridView</i> adds drag and drop to a <a href="https://developer.ubuntu.comapps/qml/sdk-15.04/QtQuick.draganddrop/#gridview">GridView</a>, allowing you to reorder the list. It also uses a DelegateModel to move a delegate item to the position of another item it is dragged over.</p>
