...
<br/>
<!-- $$$dropdownColor -->
<table class="qmlname"><tr valign="top" id="dropdownColor-prop"><td class="tblQmlPropNode"><p><span class="name">dropdownColor</span> : <span class="type">color</span></p></td></tr></table><p>The property specifies the color of the dropdown button and the combo list for both collapsed and expanded states. You can use <a href="#expanded-prop">expanded</a> to define different colors for expanded or collapsed states.</p>
<!-- @@@dropdownColor -->
<br/>
<!-- $$$expanded -->
