...
<p class="centerAlign"><img src="https://developer.ubuntu.com/static/devportal_uploaded/5c029aa7-3f8f-4461-879b-e9979fa58294-../qml-tutorial1/images/declarative-tutorial1.png" alt="" /></p><p>Here is the QML code for the application:</p>
...
<h3 >Import</h3>
<p>First, we need to import the types that we need for this example. Most QML files will import the built-in QML types (like <a href="QtQuick.Rectangle.md">Rectangle</a>, <a href="https://developer.ubuntu.comapps/qml/sdk-15.04.1/QtQuick.imageelements/#image">Image</a>, ..&#x2e;) that come with Qt, using:</p>
