...
<p class="centerAlign"><img src="https://developer.ubuntu.com/static/devportal_uploaded/81fe8711-15f7-4a2d-b7b8-963b29ed99ba-../qtquick-demos-photoviewer-example/images/qtquick-demo-photoviewer-small.png" alt="" /></p><p><i>Photo Viewer</i> demonstrates the following <a href="QtQuick.qtquick-index.md">Qt Quick</a> features:</p>
<ul>
...
<p>We use a <a href="https://developer.ubuntu.comapps/qml/sdk-15.04.1/QtQuick.draganddrop/#gridview">GridView</a> type to lay out the albums as a grid:</p>
...
<p>We use a <a href="https://developer.ubuntu.comapps/qml/sdk-15.04.1/QtQuick.imageelements/#borderimage">BorderImage</a> type to create borders for the images:</p>
