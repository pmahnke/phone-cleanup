...
<p class="centerAlign"><img src="https://developer.ubuntu.com/static/devportal_uploaded/75df3301-368c-427f-90b2-09f64a3a9de6-../qtqml-qml-i18n-example/images/qml-i18n-example.png" alt="" /></p><p>This is an internationalization example<p>The QML runtime automatically loads a translation from the i18n subdirectory of the root QML file, based on the system language.</p>
