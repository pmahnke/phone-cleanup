...
<p>A container can be any item, however it is preferable to use positioners or <a href="http://qt-project.org/doc/qt-5.3/qtquick-module.html">QtQuick</a> layout elements whenever possible.</p>
