...
<!-- $$$maze-description -->
<p class="centerAlign"><img src="https://developer.ubuntu.com/static/devportal_uploaded/f89be9f7-6793-4c05-bced-86b45ba761a7-../qtsensors-maze-example/images/maze.png" alt="" /></p>
<h3>Maze in QML</h3>
<p>The Maze example demonstrates the <a href="QtSensors.TiltSensor.md">TiltSensor</a> QML type.<p>To write a QML application that will use the <a href="QtSensors.TiltSensor.md">TiltSensor</a> QML sensors type you need to do the following steps:</p>
