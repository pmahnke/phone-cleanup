...
<p class="centerAlign"><img src="https://developer.ubuntu.com/static/devportal_uploaded/d66a38eb-a0d2-4227-8f34-3647ce963cb5-../qtquick-shadereffects-example/images/qml-shadereffects-example.png" alt="" /></p><p>This is a shader effects example<p>This example demonstrates a couple of visual effects that you can perform with shaders in <a href="QtQuick.qtquick-index.md">Qt Quick</a>.</p>
<p>ShaderEffects typically operate on other types, using a <a href="QtQuick.ShaderEffectSource.md">ShaderEffectSource</a></p>
...
<p>In the above snippet, theItem is the id of a complex QML object in the file.</p>
...
<p>ShaderEffects can also have a custom vertext shader. Setting the mesh property on <a href="QtQuick.ShaderEffect.md">ShaderEffect</a> provides more vertices for you to manipulate, enabling many effects.</p>
