...
<p class="centerAlign"><img src="https://developer.ubuntu.com/static/devportal_uploaded/8dd7a0e7-7e5b-4c55-82d6-c9fce06fbb8d-../qtquick-tutorials-samegame-samegame1-example/images/declarative-adv-tutorial1.png" alt="" /></p><p>This is defined by the main application file, <tt>samegame.qml</tt>, which looks like this:</p>
...
<p>Notice the anchors for the <tt>Item</tt>, <tt>Button</tt> and <tt>Text</tt> types are set using group (dot) notation for readability.</p>
<h3>Adding <tt>Button</tt> and <tt>Block</tt> components</h3>
<p>The <tt>Button</tt> item in the code above is defined in a separate component file named <tt>Button.qml</tt>. To create a functional button, we use the QML types <a href="QtQuick.Text.md">Text</a> and <a href="QtQuick.MouseArea.md">MouseArea</a> inside a <a href="QtQuick.Rectangle.md">Rectangle</a>. Here is the <tt>Button.qml</tt> code:</p>
<pre class="qml">import QtQuick 2.0
<span class="type"><a href="QtQuick.Rectangle.md">Rectangle</a></span> {
...
<p>This essentially defines a rectangle that contains text and can be clicked. The <a href="QtQuick.MouseArea.md">MouseArea</a> has an <tt>onClicked()</tt> handler that is implemented to emit the <tt>clicked()</tt> signal of the <tt>container</tt> when the area is clicked.</p>
...
<p>Notice the relative path for the Image type's <tt>source</tt> property. This path is relative to the location of the file that contains the <a href="QtQuick.Image.md">Image</a> type. Alternatively, you could set the Image source to an absolute file path or a URL that contains an image.</p>
...
<a class="nextPage" href="https://developer.ubuntu.comapps/qml/sdk-14.10/QtQuick.tutorials-samegame-samegame2/">QML Advanced Tutorial 2 - Populating the Game Canvas</a>
</p>
