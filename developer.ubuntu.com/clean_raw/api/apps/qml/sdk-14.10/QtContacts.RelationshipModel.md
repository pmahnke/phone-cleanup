...
<p>There are two ways of accessing the relationship data: through model by using views and delegates, or alternatively via <a href="https://developer.ubuntu.comapps/qml/sdk-14.10/QtContacts.qtcontacts-overview/#relationships">relationships</a> list property.</p>
