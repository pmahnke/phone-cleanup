...
<p>The TiltReading element holds the most recent <a href="QtSensors.TiltSensor.md">TiltSensor</a> reading.</p>
...
<!-- $$$xRotation -->
<table class="qmlname"><tr valign="top"><td class="tblQmlPropNode"><p><span class="name">xRotation</span> : <span class="type">qreal</span></p></td></tr></table><p>This property holds the amount of tilt on the X axis.</p>
<p>Please see QTiltReading::xRotation for information about this property.</p>
<!-- @@@xRotation -->
<br/>
<!-- $$$yRotation -->
<table class="qmlname"><tr valign="top"><td class="tblQmlPropNode"><p><span class="name">yRotation</span> : <span class="type">qreal</span></p></td></tr></table><p>This property holds the amount of tilt on the Y axis.</p>
