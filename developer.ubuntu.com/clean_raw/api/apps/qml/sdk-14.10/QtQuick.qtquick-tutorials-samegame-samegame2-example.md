...
<ul>
<li>Qt.createComponent() is called to generate a type from <tt>Block.qml</tt>. If the component is ready, we can call <tt>createObject()</tt> to create an instance of the <tt>Block</tt> item.</li>
...
<p>Now we need to call the JavaScript code in <tt>samegame.js</tt> from our QML files. To do this, we add this line to <tt>samegame.qml</tt> which imports the JavaScript file as a module:</p>
...
<p class="centerAlign"><img src="https://developer.ubuntu.com/static/devportal_uploaded/cdf1aa3e-e276-4704-b107-a2069d0b168f-../qtquick-tutorials-samegame-samegame2-example/images/declarative-adv-tutorial2.png" alt="" /></p><p>Now, we have a screen of blocks, and we can begin to add the game mechanics.</p>
<p>Files:</p>
<ul>
...
<a class="prevPage" href="https://developer.ubuntu.comapps/qml/sdk-14.10/QtQuick.tutorials-samegame-samegame1/">QML Advanced Tutorial 1 - Creating the Game Canvas and Blocks</a>
<a class="nextPage" href="https://developer.ubuntu.comapps/qml/sdk-14.10/QtQuick.tutorials-samegame-samegame3/">QML Advanced Tutorial 3 - Implementing the Game Logic</a>
</p>
