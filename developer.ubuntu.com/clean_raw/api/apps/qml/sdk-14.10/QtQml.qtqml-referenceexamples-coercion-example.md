...
<p>C++ Inheritance and Coercion<p>This example builds on:</p>
<ul>
...
<p>The Inheritance and Coercion Example shows how to use base classes to assign types of more than one type to a property. It specializes the Person type developed in the previous examples into two types - a <tt>Boy</tt> and a <tt>Girl</tt>.</p>
