...
<p><a href="https://developer.ubuntu.comapps/qml/sdk-15.04.3/QtQuick.animation/#pathinterpolator">PathInterpolator</a> provides <code>x</code>, <code>y</code>, and <code>angle</code> information for a particular <code>progress</code> along a path.</p>
...
<p>Typical usage of <a href="https://developer.ubuntu.comapps/qml/sdk-15.04.3/QtQuick.animation/#pathinterpolator">PathInterpolator</a> is to set the progress (often via a <a href="QtQuick.NumberAnimation.md">NumberAnimation</a>), and read the corresponding values for x, y, and angle (often via bindings to these values).</p>
