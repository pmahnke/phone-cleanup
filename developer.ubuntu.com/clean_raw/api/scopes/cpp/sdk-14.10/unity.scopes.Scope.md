...
<img src="https://developer.ubuntu.com/static/devportal_uploaded/22608e12-73f2-4059-b12b-2008c26cd7bc-../unity.scopes.Scope/classunity_1_1scopes_1_1_scope__inherit__graph.png" border="0" usemap="#unity_1_1scopes_1_1_scope_inherit__map" alt="Inheritance graph"/>
...
<table class="params">
<tr><td class="paramname">result</td><td>activated result </td></tr>
<tr><td class="paramname">metadata</td><td>additional data to pass to scope </td></tr>
...
<dl class="params"><dt>Parameters</dt><dd>
<table class="params">
<tr><td class="paramname">result</td><td><a class="el" href="unity.scopes.Result.md" title="The attributes of a result returned by a Scope. ">Result</a> that was previewed. </td></tr>
<tr><td class="paramname">metadata</td><td>additional data to pass to scope </td></tr>
<tr><td class="paramname">widget_id</td><td>identifier of 'actions' widget of activated action </td></tr>
<tr><td class="paramname">action_id</td><td>identifier of an action to activate </td></tr>
<tr><td class="paramname">reply</td><td>The callback object to receive replies </td></tr>
</table>
</dd>
</dl>
...
<dl class="params"><dt>Parameters</dt><dd>
<table class="params">
<tr><td class="paramname">result</td><td><a class="el" href="unity.scopes.Result.md" title="The attributes of a result returned by a Scope. ">Result</a> to be previewed </td></tr>
<tr><td class="paramname">metadata</td><td>additional data to pass to scope </td></tr>
<tr><td class="paramname">reply</td><td>The callback object to receive replies </td></tr>
</table>
</dd>
...
<dl class="params"><dt>Parameters</dt><dd>
<table class="params">
<tr><td class="paramname">query_string</td><td>search string </td></tr>
<tr><td class="paramname">metadata</td><td>additional data to pass to scope </td></tr>
<tr><td class="paramname">reply</td><td>The callback object to receive replies </td></tr>
</table>
</dd>
...
<table class="params">
<tr><td class="paramname">query_string</td><td>search string </td></tr>
<tr><td class="paramname">filter_state</td><td>state of filters </td></tr>
<tr><td class="paramname">metadata</td><td>additional data to pass to scope </td></tr>
<tr><td class="paramname">reply</td><td>The callback object to receive replies </td></tr>
</table>
</dd>
...
<table class="params">
<tr><td class="paramname">query_string</td><td>search string </td></tr>
<tr><td class="paramname">department_id</td><td>identifier of a department to search </td></tr>
<tr><td class="paramname">filter_state</td><td>state of filters </td></tr>
<tr><td class="paramname">metadata</td><td>additional data to pass to scope </td></tr>
<tr><td class="paramname">reply</td><td>The callback object to receive replies </td></tr>
</table>
...
<dl class="section return"><dt>Returns</dt><dd>query handler </dd></dl>
