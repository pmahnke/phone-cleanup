...
See [Qt Quick Examples - Key Interaction](https://developer.ubuntu.comapps/qml/sdk-15.04.1/QtQuick.keyinteraction/) for a demonstration of moving keyboard focus between multiple areas using [FocusScope](../QtQuick.FocusScope.md) types.
...
All of the QML view classes, such as [PathView](../QtQuick.PathView.md) and [GridView](https://developer.ubuntu.comapps/qml/sdk-15.04.1/QtQuick.draganddrop/#gridview), behave in a similar manner to allow key handling in their respective delegates.
