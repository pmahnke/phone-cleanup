...
**See also** [Grid::layoutDirection](../QtQuick.Grid.md#layoutDirection-prop), [Flow::layoutDirection](../QtQuick.Flow.md#layoutDirection-prop), and [Qt Quick Examples - Right to Left](https://developer.ubuntu.comapps/qml/sdk-15.04.1/QtQuick.righttoleft/).
