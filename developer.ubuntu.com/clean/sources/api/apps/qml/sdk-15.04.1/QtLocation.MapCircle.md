...
[MapCircle](index.html) performance is almost equivalent to that of a [MapPolygon](../QtLocation.MapPolygon.md) with 125 vertices. There is a small amount of additional overhead with respect to calculating the vertices first.
