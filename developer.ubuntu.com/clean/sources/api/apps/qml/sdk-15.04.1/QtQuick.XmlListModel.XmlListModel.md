...
[XmlListModel](../QtQuick.qtquick-modelviewsdata-modelview.md#xmllistmodel) is used to create a read-only model from XML data. It can be used as a data source for view elements (such as [ListView](../QtQuick.ListView.md), [PathView](../QtQuick.PathView.md), [GridView](https://developer.ubuntu.comapps/qml/sdk-15.04.1/QtQuick.draganddrop/#gridview)) and other elements that interact with model data (such as [Repeater](../QtQuick.Repeater.md)).
...
**See also** [Qt Quick Demo - RSS News](https://developer.ubuntu.comapps/qml/sdk-15.04.1/QtQuick.demos-rssnews/).
