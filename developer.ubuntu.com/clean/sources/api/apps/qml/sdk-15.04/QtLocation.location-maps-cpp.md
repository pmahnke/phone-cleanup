...
Currently it is not possible to interact with maps via C++. Mapping applications must use the [Maps and Navigation (QML)](../QtLocation.location-maps-qml.md) API.
