...
The current Map plugin in use is contained in the [plugin](../QtLocation.location-places-qml.md#plugin) property of the Map item. In order to display any image in a Map item, you will need to set this property. See the [Plugin](../QtLocation.location-places-qml.md#plugin) type for a description of how to retrieve an appropriate plugin for use.
...
The maximum zoom level is defined by the [plugin](../QtLocation.location-places-qml.md#plugin) used. If a plugin supporting mapping is not set, -1.0 is returned.
...
The minimum zoom level is defined by the [plugin](../QtLocation.location-places-qml.md#plugin) used. If a plugin supporting mapping is not set, -1.0 is returned.
