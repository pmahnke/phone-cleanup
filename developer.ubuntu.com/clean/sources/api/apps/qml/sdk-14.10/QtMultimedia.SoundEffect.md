...
This property contains the number of loops remaining before the sound effect stops by itself, or [SoundEffect](index.html).Infinite if that's what has been set in [loops](#loops-prop).
