...
-   New [Grid](../QtQuick.Grid.md) properties: horizontalAlignment, verticalAlignment, and effectiveHorizontalAlignment.
...
-   New [SpriteSequence](../QtQuick.SpriteSequence.md) type renders animated sprites and can transition between animations. Each animation in a sequence is represented by the new [Sprite](../QtQuick.Sprite.md) type.
-   New [AnimatedSprite](../QtQuick.AnimatedSprite.md) type for drawing single sprite animations.
...
-   New [PathAnimation](../QtQuick.PathAnimation.md) type animates an item along a [Path](../QtQuick.Path.md).
-   New [PathInterpolator](../QtQuick.PathInterpolator.md) type provides updated attribute values for an item animating along a path. It can be used as an low-level alternative to [PathAnimation](../QtQuick.PathAnimation.md).
...
-   Changes common to [Text](../QtQuick.Text.md), [TextEdit](../QtQuick.TextEdit.md) and [TextInput](../QtQuick.TextInput.md):
...
-   Changes common to [Row](../QtQuick.Row.md), [Column](../QtQuick.Column.md), [Grid](../QtQuick.Grid.md) and [Flow](../QtQuick.Flow.md):
...
-   Changes common to both [ListView](../QtQuick.ListView.md) and [GridView](../QtQuick.GridView.md):
    -   New transition support for animating the adding, removing and moving of items in a [ListView](../QtQuick.ListView.md) or [GridView](../QtQuick.GridView.md). See the [ViewTransition](../QtQuick.ViewTransition.md) documentation for details.
...
-   [GridView](../QtQuick.GridView.md) only:
...
| matrix4x4  | Qt.[matrix4x4](../QtQuick.Matrix4x4.md)()                           |
...
This new module contains the [Window](../QtQuick.Window.Window.md) type for creating a basic window and the [Screen](../QtQuick.Window.Screen.md) type for accessing a screen's resolution and other details. See the QtQuick.Window documentation for comprehensive details.
