...
In some cases you may want to decode a compressed audio file and do further processing yourself (like mix multiple samples, or some custom digital signal processing algorithms). Qt Multimedia 5.0 offers a preliminary API for this case - the QAudioDecoder class. QAudioDecoder supports decoding local files or from a QIODevice instances.
...
Note: This API is preliminary at this time - the API may change or be removed before the final 5.0 release.
