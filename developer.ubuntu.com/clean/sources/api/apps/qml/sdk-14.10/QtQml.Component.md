...
Emitted as the component begins destruction. This can be used to undo work done in response to the [completed()](#completed-signal) signal, or other imperative code in your application.
