...
The name can potentially be localized. The language is dependent on the entity that sets it, typically this is the [Plugin](../QtLocation.Plugin.md). The [Plugin::locales](../QtLocation.Plugin.md#locales-prop) property defines what language is used.
