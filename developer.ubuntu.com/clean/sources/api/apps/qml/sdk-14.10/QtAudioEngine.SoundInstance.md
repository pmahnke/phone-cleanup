...
There are two ways to create SoundInstance objects. You can obtain it by calling newInstance method of a [Sound](../QtAudioEngine.Sound.md):
...
Or alternatively, you can explicitly define SoundInstance outside of [AudioEngine](../QtAudioEngine.AudioEngine.md) for easier qml bindings:
...
<tbody>
<tr class="odd">
<td><p><span id="stateChanged-signal"></span><span class="name">stateChanged</span>(<span class="type"><a href="#state-prop">state</a></span>)</p></td>
</tr>
</tbody>
</table>
