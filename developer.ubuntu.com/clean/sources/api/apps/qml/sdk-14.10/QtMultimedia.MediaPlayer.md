...
You can use MediaPlayer by itself to play audio content (like [Audio](../QtMultimedia.Audio.md)), or you can use it in conjunction with a [VideoOutput](../QtMultimedia.VideoOutput.md) for rendering video.
