...
Item (and all derived types) provides built in support for states and transitions via its [state](../QtQuick.Item.md#state-prop), [states](../QtQuick.Item.md#states-prop) and [transitions](../QtQuick.Item.md#transitions-prop) properties. StateGroup provides an easy way to use this support in other (non-Item-derived) types.
