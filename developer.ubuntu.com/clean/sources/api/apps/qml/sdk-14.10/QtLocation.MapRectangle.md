...
Like the other map objects, MapRectangle is normally drawn without a smooth appearance. Setting the [opacity](#opacity-prop) property will force the object to be blended, which decreases performance considerably depending on the hardware in use.
