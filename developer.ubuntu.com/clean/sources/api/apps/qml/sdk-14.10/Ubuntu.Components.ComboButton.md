...
-   ****[dropdownColor](#dropdownColor-prop)**** : color
...
-   In case the content is a single Flickable, [ListView](../QtQuick.ListView.md), [GridView](../QtQuick.GridView.md) or [PathView](../QtQuick.PathView.md), the content will be filling the entire combo list area defined.
...
<tbody>
<tr class="odd">
<td><p><span id="comboList-prop"></span><span class="qmldefault">default</span><span class="name">comboList</span> : <span class="type"><a href="http://qt-project.org/doc/qt-5.3/qml-list.html">list</a></span>&lt;<span class="type"><a href="QtQuick.Item.md">Item</a></span>&gt;</p></td>
</tr>
</tbody>
</table>
...
The property specifies the color of the dropdown button and the combo list for both collapsed and expanded states. You can use [expanded](#expanded-prop) to define different colors for expanded or collapsed states.
