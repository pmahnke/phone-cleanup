...
The following snippet shows how to use a UniformAnimator together with a [ShaderEffect](../QtQuick.ShaderEffect.md) item.
...
It is also possible to use the `on` keyword to tie the UniformAnimator directly to a uniform of a [ShaderEffect](../QtQuick.ShaderEffect.md) instance.
