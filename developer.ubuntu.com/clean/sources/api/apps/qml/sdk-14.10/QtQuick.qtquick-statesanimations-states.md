...
State changes induce abrupt value changes. The [Transition](../QtQuick.Transition.md) type allow smoother changes during state changes. In transitions, animations and interpolation behaviors are definable. The [Animation and Transitions](../QtQuick.qtquick-statesanimations-animations.md) article has more information about creating state animations.
