...
The Spectrum Analyzer example shows how the [Qt Multimedia](../QtMultimedia.qtmultimedia-index.md) module can be used to record and then play back an audio stream.
