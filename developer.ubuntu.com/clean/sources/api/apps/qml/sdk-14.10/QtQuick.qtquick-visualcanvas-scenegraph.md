...
For more details, see the [Scene Graph - Custom Geometry](https://developer.ubuntu.comapps/qml/sdk-14.10/QtQuick.scenegraph-customgeometry/).
...
For more details, see the [Scene Graph - Simple Material](https://developer.ubuntu.comapps/qml/sdk-14.10/QtQuick.scenegraph-simplematerial/)
...
The [Scene Graph - OpenGL Under QML](https://developer.ubuntu.comapps/qml/sdk-14.10/QtQuick.scenegraph-openglunderqml/) example gives an example on how to use use these signals.
...
-   Custom textures; specifically the implementation of QQuickWindow::createTextureFromImage and the internal representation of the texture used by [Image](../QtQuick.Image.md) and [BorderImage](../QtQuick.BorderImage.md) types.
