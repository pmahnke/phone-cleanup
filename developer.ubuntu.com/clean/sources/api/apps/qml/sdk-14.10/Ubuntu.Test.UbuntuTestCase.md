...
<td><code>import Ubuntu.Test .</code></td>
</tr>
<tr class="even">
<td>Inherits:</td>
...
-   ****[mouseMoveSlowly](#mouseMoveSlowly-method)****(*item*, *x*, *y*, *dx*, *dy*, *steps*, *stepdelay*)
...
This class extends the default QML [TestCase](../QtTest.TestCase.md) class which is available in [QtTest](http://qt-project.org/doc/qt-5.3/qttest-qmlmodule.html) 1.0.
