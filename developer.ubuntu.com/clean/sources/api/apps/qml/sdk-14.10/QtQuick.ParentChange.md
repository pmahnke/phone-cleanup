...
You can specify at which point in a transition you want a ParentChange to occur by using a [ParentAnimation](../QtQuick.ParentAnimation.md).

Note that unlike [PropertyChanges](../QtQuick.PropertyChanges.md), ParentChange expects an Item-based target; it will not work with arbitrary objects (for example, you couldn't use it to reparent a Timer).
