...
RouteSegment instances can be thought of as edges on a routing graph, with [RouteManeuver](../QtLocation.RouteManeuver.md) instances as optional labels attached to the vertices of the graph.
