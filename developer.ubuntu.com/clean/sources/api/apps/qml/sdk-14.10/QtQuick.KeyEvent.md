...
See Qt.Key for the list of keyboard codes. These codes are independent of the underlying window system. Note that this function does not distinguish between capital and non-capital letters, use the [text()](../QtQuick.Text.md) function (returning the Unicode text the key generated) for this purpose.
