...
The [Drag](../QtQuick.Drag.md) attached property can be used to notify the DropArea when an Item is dragged over it.
...
**See also** [QtQuick::Drag::keys](../QtQuick.Drag.md#keys-prop).
