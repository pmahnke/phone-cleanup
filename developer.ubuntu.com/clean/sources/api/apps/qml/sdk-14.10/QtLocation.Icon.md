...
The Icon type also has a parameters map which is a set of key value pairs. The precise keys to use depend on the [plugin](../QtLocation.qtlocation-index.md#plugin-references-and-parameters) being used. The parameters map is used by the [Plugin](../QtLocation.Plugin.md) to determine which URL to return.
