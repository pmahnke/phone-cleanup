...
|                                                                                      |                                                    |
|--------------------------------------------------------------------------------------|----------------------------------------------------|
| [Maps and Navigation](../QtLocation.location-maps-cpp.md)                    | Displaying maps and finding routes.                |
| [Places](../QtLocation.location-places-cpp.md)                               | Searching for and managing points of interest.     |
| [Geoservices Plugin Implementation](../QtLocation.qtlocation-geoservices.md) | Implement new geoservices and positioning plugins. |
...
Currently it is not possible to interact with maps data via C++. The only available interface is the [Maps and Navigation (QML)](../QtLocation.location-maps-qml.md) API.
