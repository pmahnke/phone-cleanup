...
PathPercent allows you to manipulate the spacing between items on a [PathView](../QtQuick.PathView.md)'s path. You can use it to bunch together items on part of the path, and spread them out on other parts of the path.
