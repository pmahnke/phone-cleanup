...
The ContactDetail provides a single detail on how one could contact a [Place](../QtLocation.Place.md). The ContactDetail consists of a [label](#label-prop), which is a localized string describing the contact method, and a [value](#value-prop) representing the actual contact detail.
...
The label can potentially be localized. The language is dependent on the entity that sets it, typically this is the [Plugin](../QtLocation.Plugin.md). The [Plugin::locales](../QtLocation.Plugin.md#locales-prop) property defines what language is used.
