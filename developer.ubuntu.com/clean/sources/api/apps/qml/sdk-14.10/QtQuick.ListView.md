...
-   ****[delayRemove](#delayRemove-prop)**** : bool
-   ****[isCurrentItem](#isCurrentItem-prop)**** : bool
-   ****[nextSection](#nextSection-prop)**** : string
-   ****[previousSection](#previousSection-prop)**** : string
-   ****[section](#section-prop)**** : string
-   ****[view](#view-prop)**** : ListView
...
A ListView displays data from models created from built-in QML types like [ListModel](../QtQuick.qtquick-modelviewsdata-modelview.md#listmodel) and [XmlListModel](../QtQuick.XmlListModel.XmlListModel.md), or custom model classes defined in C++ that inherit from [QAbstractItemModel](../QtQuick.qtquick-modelviewsdata-cppmodels.md#qabstractitemmodel) or QAbstractListModel.

A ListView has a [model](#model-prop), which defines the data to be displayed, and a [delegate](#delegate-prop), which defines how the data should be displayed. Items in a ListView are laid out horizontally or vertically. List views are inherently flickable because ListView inherits from [Flickable](../QtQuick.Flickable.md).
...
![](https://developer.ubuntu.com/static/devportal_uploaded/8678b562-0129-4c40-b034-594777cea941-api/apps/qml/sdk-14.10/QtQuick.ListView/images/listview-simple.png)

Here, the ListView creates a `ContactModel` component for its model, and a [Text](../QtQuick.Text.md) item for its delegate. The view will create a new [Text](../QtQuick.Text.md) component for each item in the model. Notice the delegate is able to access the model's `name` and `number` data directly.
...
![](https://developer.ubuntu.com/static/devportal_uploaded/1f52941b-61ea-483e-9ca5-0c6a38eb25f0-api/apps/qml/sdk-14.10/QtQuick.ListView/images/listview-highlight.png)

The currently selected item is highlighted with a blue [Rectangle](../QtQuick.Rectangle.md) using the [highlight](#highlight-prop) property, and `focus` is set to `true` to enable keyboard navigation for the list view. The list view itself is a focus scope (see [Keyboard Focus in Qt Quick](../QtQuick.qtquick-input-focus.md) for more details).

Delegates are instantiated as needed and may be destroyed at any time. They are parented to ListView's [contentItem](../QtQuick.Flickable.md#contentItem-prop), not to the view itself. State should *never* be stored in a delegate.
...
Top to bottom
![](https://developer.ubuntu.com/static/devportal_uploaded/0951f10d-6786-482b-8cbc-7f620a264de3-api/apps/qml/sdk-14.10/QtQuick.ListView/images/listview-layout-toptobottom.png)

Bottom to top
![](https://developer.ubuntu.com/static/devportal_uploaded/ea4f88c9-9d64-4d45-a30b-18aafd98efbf-api/apps/qml/sdk-14.10/QtQuick.ListView/images/listview-layout-bottomtotop.png)

**ListViews** with Qt.Horizontal orientation
Left to right
![](https://developer.ubuntu.com/static/devportal_uploaded/0ffaec37-46a4-49ab-8b6f-41b55148c26b-api/apps/qml/sdk-14.10/QtQuick.ListView/images/listview-layout-lefttoright.png)

Right to left
![](https://developer.ubuntu.com/static/devportal_uploaded/e74e5d24-b868-4af2-aaeb-ef7f3309b8d7-api/apps/qml/sdk-14.10/QtQuick.ListView/images/listview-layout-righttoleft.png)

**See also** [QML Data Models](../QtQuick.qtquick-modelviewsdata-modelview.md#qml-data-models), [GridView](../QtQuick.GridView.md), [PathView](../QtQuick.PathView.md), and [Qt Quick Examples - Views](https://developer.ubuntu.comapps/qml/sdk-14.10/QtQuick.views/).
...
**See also** [highlightItem](#highlightItem-prop), [highlightFollowsCurrentItem](#highlightFollowsCurrentItem-prop), and [ListView highlight example](https://developer.ubuntu.comapps/qml/sdk-14.10/QtQuick.views/#highlight-demonstrates-adding-a-custom-highlight-to-a-listview).
...
**See also** [highlight](#highlight-prop) and [highlightMoveVelocity](#highlightMoveVelocity-prop).
...
This holds the highlight item created from the [highlight](#highlight-prop) component.
...
**See also** [highlight](#highlight-prop) and [highlightFollowsCurrentItem](#highlightFollowsCurrentItem-prop).
...
<p><img src="https://developer.ubuntu.com/static/devportal_uploaded/76a98647-172a-42e4-af29-54088107473c-api/apps/qml/sdk-14.10/QtQuick.ListView/images/ListViewHorizontal.png" /></p></td>
</tr>
<tr class="even">
<td>Vertical orientation:
<p><img src="https://developer.ubuntu.com/static/devportal_uploaded/594d88a5-cdae-4474-a86a-c2aade092610-api/apps/qml/sdk-14.10/QtQuick.ListView/images/listview-highlight.png" /></p></td>
</tr>
</tbody>
</table>
...
Additionally, if the [delayRemove](#delayRemove-prop) attached property has been set for a delegate item, the remove transition will not be applied until [delayRemove](#delayRemove-prop) becomes false again.
...
![](https://developer.ubuntu.com/static/devportal_uploaded/df8cab4e-fc21-49ad-aa54-cbf3a3d7d426-api/apps/qml/sdk-14.10/QtQuick.ListView/images/qml-listview-sections-example.png)
...
<tbody>
<tr class="odd">
<td><p><span id="nextSection-prop"></span><span class="name">.nextSection</span> : <span class="type">string</span></p></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td><p><span id="previousSection-prop"></span><span class="name">.previousSection</span> : <span class="type">string</span></p></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td><p><span id="section-prop"></span><span class="name">.section</span> : <span class="type">string</span></p></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td><p><span id="view-prop"></span><span class="name">.view</span> : <span class="type">ListView</span></p></td>
</tr>
</tbody>
</table>
...
If a [remove](#remove-prop) transition has been specified, it is applied after this signal is handled, providing that [delayRemove](#delayRemove-prop) is false.
