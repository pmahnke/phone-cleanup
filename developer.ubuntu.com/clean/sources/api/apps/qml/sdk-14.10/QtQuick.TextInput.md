...
TextInput is used to accept a line of text input. Input constraints can be placed on a TextInput item (for example, through a [validator](#validator-prop) or [inputMask](#inputMask-prop)), and setting [echoMode](#echoMode-prop) to an appropriate value enables TextInput to be used for a password input field.
...
**See also** [TextEdit](../QtQuick.TextEdit.md), [Text](../QtQuick.Text.md), and Text Selection example.
...
If [echoMode](#echoMode-prop) is set to TextInput::Normal, this holds the same value as the [TextInput::text](#text-prop) property. Otherwise, this property holds the text visible to the user, while the [text](https://developer.ubuntu.comapps/qml/sdk-14.10/QtQuick.text/) property holds the actual entered text.
...
If the [TextInput](index.html) has an [inputMask](#inputMask-prop) the length will include mask characters and may differ from the length of the string returned by the [text](https://developer.ubuntu.comapps/qml/sdk-14.10/QtQuick.text/) property.

This property can be faster than querying the length the [text](https://developer.ubuntu.comapps/qml/sdk-14.10/QtQuick.text/) property as it doesn't require any copying or conversion of the [TextInput](index.html)'s internal string data.
