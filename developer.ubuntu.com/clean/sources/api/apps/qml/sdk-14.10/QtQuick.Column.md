...
For example, the Column below sets the [move](#move-prop) property to a specific [Transition](../QtQuick.Transition.md):
...
**See also** [Row](../QtQuick.Row.md), [Grid](../QtQuick.Grid.md), [Flow](../QtQuick.Flow.md), [Positioner](../QtQuick.Positioner.md), ColumnLayout, and [Qt Quick Examples - Positioners](https://developer.ubuntu.comapps/qml/sdk-14.10/QtQuick.positioners/).
