...
*PathAnimation* animates an image along a bezier curve using a [PathAnimation](https://developer.ubuntu.comapps/qml/sdk-15.04.3/QtQuick.animation/#pathanimation).
...
*PathInterpolator* animates an image along the same bezier curve, using a [PathInterpolator](https://developer.ubuntu.comapps/qml/sdk-15.04.3/QtQuick.animation/#pathinterpolator) instead.
