...
For more details, see the [Scene Graph - Custom Geometry](https://developer.ubuntu.comapps/qml/sdk-15.04.3/QtQuick.scenegraph-customgeometry/).
...
For more details, see the [Scene Graph - Simple Material](https://developer.ubuntu.comapps/qml/sdk-15.04.3/QtQuick.scenegraph-simplematerial/)
...
The [Scene Graph - OpenGL Under QML](https://developer.ubuntu.comapps/qml/sdk-15.04.3/QtQuick.scenegraph-openglunderqml/) example gives an example on how to use these signals.
