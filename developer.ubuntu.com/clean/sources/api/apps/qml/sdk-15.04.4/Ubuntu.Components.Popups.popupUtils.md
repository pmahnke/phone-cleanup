...
*caller* should be given when a [ComposerSheet](https://developer.ubuntu.comapps/qml/sdk-15.04.4/Ubuntu.Components.Popups.ComposerSheet/) or [Dialog](../Ubuntu.Components.Popups.Dialog.md) is specified using a URL and opened inside a **Window**. If not, the application's root item will be the dismiss area.
...
See [Popover](../Ubuntu.Components.Popups.Popover.md), [ComposerSheet](https://developer.ubuntu.comapps/qml/sdk-15.04.4/Ubuntu.Components.Popups.ComposerSheet/) and [Dialog](../Ubuntu.Components.Popups.Dialog.md) for their respective documentation and more examples.
