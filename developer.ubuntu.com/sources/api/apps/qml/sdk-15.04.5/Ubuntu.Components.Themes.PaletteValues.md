...
-   ****[overlaySecondaryText](index.html#overlaySecondaryText-prop)**** : color
...
Color applied to elements placed on top of the [overlay](index.html#overlay-prop) color. Typically used for labels and images.
