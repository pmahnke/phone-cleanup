...
For information about how the Model/View paradigm is implemented in Qt Quick, see the page titled [Models and Views in Qt Quick](../QtQuick.qtquick-modelviewsdata-modelview/index.html).

<span id="data-storage-and-access"></span>
Data Storage and Access
-----------------------

Databases are commonly used to store information in applications. Qt Quick provides simplified access to relational databases via the [QtQuick.LocalStorage](../QtQuick.qtquick-releasenotes/index.html#qtquick-localstorage) module.
