...
See [Qt Quick Examples - Key Interaction](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.5/QtQuick.keyinteraction/) for a demonstration of moving keyboard focus between multiple areas using [FocusScope](../QtQuick.FocusScope/index.html) types.
...
All of the QML view classes, such as [PathView](../QtQuick.PathView/index.html) and [GridView](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.5/QtQuick.draganddrop/#gridview), behave in a similar manner to allow key handling in their respective delegates.
