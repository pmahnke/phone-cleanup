...
-   object ****[createAccount](index.html#createAccount-method)****(string *providerName*)
-   object ****[loadAccount](index.html#loadAccount-method)****(uint *accountId*)
...
**See also** [loadAccount()](index.html#loadAccount-method).
...
Loads the account identified by *accountId*. The returned object can be used to instantiate an [Account](../Ubuntu.OnlineAccounts.Account/index.html).

**See also** [createAccount()](index.html#createAccount-method).
