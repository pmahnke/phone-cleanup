...
-   ****[direction](index.html#direction-prop)**** : enum
-   ****[distance](index.html#distance-prop)**** : real
-   ****[dragging](index.html#dragging-prop)**** : bool
-   ****[grabGesture](index.html#grabGesture-prop)**** : bool
...
**Note:** When used with a Flickable (or [ListView](../QtQuick.ListView/index.html), [GridView](../../sdk-14.10/QtQuick.qtquick-draganddrop-example/index.html#gridview)) always put the [SwipeArea](index.html) next to the Flickable as sibling.
...
Drives whether the gesture should be recognized as soon as the touch lands on the area. With this property set it will work the same way as a [MultiPointTouchArea](../QtQuick.MultiPointTouchArea/index.html),
