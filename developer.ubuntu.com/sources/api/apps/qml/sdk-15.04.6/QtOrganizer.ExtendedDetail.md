...
The ExtendedDetail element contains a extended detail of an organizer item. More...
...
-   ****[data](index.html#data-prop)**** : variant
...
-   [ExtendedDetail](index.html).FieldName
-   [ExtendedDetail](index.html).FieldData
