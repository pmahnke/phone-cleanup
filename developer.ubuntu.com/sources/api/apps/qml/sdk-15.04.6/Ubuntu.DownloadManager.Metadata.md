...
-   ****[custom](index.html#custom-prop)**** : array
-   ****[extract](index.html#extract-prop)**** : bool
-   ****[showInIndicator](index.html#showInIndicator-prop)**** : bool
...
Metadata provides the ability to set a number of special properties on a [SingleDownload](../Ubuntu.DownloadManager.SingleDownload/index.html), e.g. to display a download in the transfer indicator, or automatically extract a download of a zip file upon completion.
...
This sets the name to display in the transfer indicator for this download, this property is only used if [showInIndicator](index.html#showInIndicator-prop) is True.
