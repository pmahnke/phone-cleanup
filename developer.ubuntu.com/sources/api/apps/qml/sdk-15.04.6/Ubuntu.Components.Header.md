...
-   ****[automaticHeight](index.html#automaticHeight-prop)**** : bool
...
The heights of the [Page](../Ubuntu.Components.Page/index.html) headers in an [AdaptivePageLayout](../Ubuntu.Components.AdaptivePageLayout/index.html) are synchronized by the [AdaptivePageLayout](../Ubuntu.Components.AdaptivePageLayout/index.html) so that they all get the height of the largest implicitHeight of the visible Page headers to give a uniform look to the headers. To opt-out of this height synchronization, set automaticHeight to false. This will prevent the [AdaptivePageLayout](../Ubuntu.Components.AdaptivePageLayout/index.html) from taking the Header's implicitHeight into account for computing the maximum header height, and it will also not update the height of the header that has automaticHeight set to false to match the other header heights. Default value: true.
...
It is permitted to use a [ListView](../QtQuick.ListView/index.html) as the value of flickable, but this works well only if the [ListView](../QtQuick.ListView/index.html).header property is not set. Alternatively, a Header component may be used for [ListView](../QtQuick.ListView/index.html).header, but in that case the flickable of the Header must be null.
