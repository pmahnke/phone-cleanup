...
-   - don't try to save [MainView](../Ubuntu.Components.MainView/index.html).applicationName, as its change will take effect next time the application is launched
-   - specify IDs for all components as well as for parents even if their presence is not justified in the document
-   types other than the ones listed in [QML base types](../../sdk-15.04.3/QtQml.qtqml-typesystem-basictypes/index.html) will not be serialized
...
See documentation on [StateSaver](../Ubuntu.Components.StateSaver/index.html) properties under [Services](../UbuntuUserInterfaceToolkit.overview-ubuntu-sdk/index.html#services) section.
