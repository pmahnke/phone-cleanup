...
-   ****[proportionalMagnitude](index.html#proportionalMagnitude-prop)**** : bool
-   ****[targetItem](index.html#targetItem-prop)**** : Item
-   ****[targetVariation](index.html#targetVariation-prop)**** : real
-   ****[targetX](index.html#targetX-prop)**** : real
-   ****[targetY](index.html#targetY-prop)**** : real
...
If true, then the value of magnitude and [magnitudeVariation](index.html#magnitudeVariation-prop) shall be interpreted as multiples of the distance between the source point and the target point, per second.

If false(default), then the value of magnitude and [magnitudeVariation](index.html#magnitudeVariation-prop) shall be interpreted as pixels per second.
...
<tbody>
<tr class="odd">
<td><p><span id="targetItem-prop"></span><span class="name">targetItem</span> : <span class="type"><a href="../QtQuick.Item/index.html">Item</a></span></p></td>
</tr>
</tbody>
</table>

If specified, this will take precedence over [targetX](index.html#targetX-prop) and [targetY](index.html#targetY-prop). The targeted point will be the center of the specified Item
