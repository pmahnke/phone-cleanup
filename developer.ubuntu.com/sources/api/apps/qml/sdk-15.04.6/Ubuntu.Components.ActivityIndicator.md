...
Note: for time consuming JavaScript operations use [WorkerScript](../../sdk-14.10/QtQuick.qtquick-threading-example/index.html#workerscript), otherwise no UI interaction will be possible and the ActicityIndicator animation will freeze.
