...
The [XMLHttpRequest example](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.6/QtQml.xmlhttprequest/) demonstrates how to use the [XMLHttpRequest](index.html#xmlhttprequest) object to make a request and read the response headers.
