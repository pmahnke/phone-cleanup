...
These properties are automatically attached to the parent item of the [ListItem](../Ubuntu.Components.ListItem/index.html), or to [ListView](../QtQuick.ListView/index.html), when the component is used as delegate.
