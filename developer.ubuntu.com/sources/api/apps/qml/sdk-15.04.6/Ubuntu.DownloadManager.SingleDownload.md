...
-   ****[algorithm](index.html#algorithm-prop)**** : string
...
-   ****[hash](index.html#hash-prop)**** : string
...
If no value is specified md5 will be used. If used, this should be set prior to calling the [download()](index.html#download-method) method.
...
This property specifies a hash to check against the downloaded file. If used, this should be set prior to calling the [download()](index.html#download-method) method.
