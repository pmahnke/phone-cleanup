...
The application uses the [ObjectModel](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.6/QtQuick.views/#objectmodel) type to access the two visual data models that it depends on.
