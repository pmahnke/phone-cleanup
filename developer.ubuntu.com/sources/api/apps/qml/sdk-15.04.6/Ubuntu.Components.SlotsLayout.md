...
The second option is to use a [MouseArea](../QtQuick.MouseArea/index.html) as a wrapper around [SlotsLayout](index.html), as the following code demonstrates:
...
**Note**: as recommended in [Resizing the layout](index.html#resizing-the-layout), since [SlotsLayout](index.html) has a dynamic height, it is important to have the parent item's height (in this case [MouseArea](../QtQuick.MouseArea/index.html)) follow [SlotsLayout](index.html)'s **height**, and not the opposite, to avoid getting the slots clipped out of the layout.
...
<tbody>
<tr class="odd">
<td><p><span id="mainSlot-prop"></span><span class="name">mainSlot</span> : <span class="type"><a href="../QtQuick.Item/index.html">Item</a></span></p></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td><p><span id="padding-attached-prop"></span><span class="name">SlotsLayout.padding</span> : <span class="type"><a href="../QtQml.QtObject/index.html">QtObject</a></span></p></td>
</tr>
</tbody>
</table>
