...
The CategoryModel type provides a model of the categories that are available from the current [Plugin](../QtLocation.Plugin/index.html). The model supports both a flat list of categories and a hierarchical tree representing category groupings. This can be controlled by the [hierarchical](index.html#hierarchical-prop) property.

The model supports the following roles:

| Role           | Type                                          | Description                                                                           |
|----------------|-----------------------------------------------|---------------------------------------------------------------------------------------|
| category       | [Category](../QtLocation.Category/index.html) | Category object for the current item.                                                 |
| parentCategory | [Category](../QtLocation.Category/index.html) | Parent category object for the current item. If there is no parent, null is returned. |
...
This property holds the provider [Plugin](../QtLocation.Plugin/index.html) used by this model.
