...
QML has a deep JavaScript integration, and allows [signal handlers](../QtQml.qtqml-syntax-objectattributes/index.html#signal-attributes) and [methods](../QtQml.qtqml-syntax-objectattributes/index.html#method-attributes) to be defined in JavaScript. One of the other fundamental concepts of QML is the ability to bind property values to the result of complex expressions which can include properties from other objects. These [property bindings](../QtQml.qtqml-syntax-propertybinding/index.html) are JavaScript expressions.

See the documentation page titled [JavaScript Expressions in QML Documents](../QtQml.qtqml-javascript-expressions/index.html) for more information about using JavaScript expressions in QML.
...
See the documentation page titled [Defining JavaScript Resources In QML](../QtQml.qtqml-javascript-resources/index.html) for more information about defining JavaScript resources for QML.
...
See the documentation page titled [Importing JavaScript Resources](../QtQml.qtqml-javascript-imports/index.html) for more information on how to import JavaScript resources and how to use the functionality they provide.
...
These limitations and extensions are documented in the description of the [JavaScript Host Environment](../QtQml.qtqml-javascript-hostenvironment/index.html) provided by the QML engine.
