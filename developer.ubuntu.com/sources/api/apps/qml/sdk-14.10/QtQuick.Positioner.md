...
-   ****[isFirstItem](index.html#isFirstItem-prop)**** : bool
-   ****[isLastItem](index.html#isLastItem-prop)**** : bool
...
For example, below is a [Grid](../QtQuick.Grid/index.html) with 16 child rectangles, as created through a [Repeater](../QtQuick.Repeater/index.html). Each [Rectangle](../QtQuick.Rectangle/index.html) displays its index in the Grid using [Positioner.index](index.html#index-prop), and the first item is colored differently by taking [Positioner.isFirstItem](index.html#isFirstItem-prop) into account:
