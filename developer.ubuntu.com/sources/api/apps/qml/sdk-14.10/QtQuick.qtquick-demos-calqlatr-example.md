...
*Calqlatr* demonstrates various QML and [Qt Quick](../QtQuick.qtquick-index/index.html) features such as displaying custom components. The logic is implemented in JavaScript and the appearance implemented in QML.
