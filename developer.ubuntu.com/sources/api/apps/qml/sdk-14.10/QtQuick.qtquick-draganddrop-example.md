...
The keys property of the [DropArea](../QtQuick.DropArea/index.html) will only allow an item with matching key in it's Drag.keys property to be dropped on it.
