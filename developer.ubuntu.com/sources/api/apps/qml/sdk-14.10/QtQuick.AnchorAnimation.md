...
When an AnchorAnimation is used in a [Transition](../QtQuick.Transition/index.html), it will animate any [AnchorChanges](../QtQuick.AnchorChanges/index.html) that have occurred during the state change. This can be overridden by setting a specific target item using the [AnchorChanges.target](../QtQuick.AnchorChanges/index.html#target-prop) property.

**Note:** AnchorAnimation can only be used in a [Transition](../QtQuick.Transition/index.html) and in conjunction with an AnchorChange. It cannot be used in behaviors and other types of animations.
