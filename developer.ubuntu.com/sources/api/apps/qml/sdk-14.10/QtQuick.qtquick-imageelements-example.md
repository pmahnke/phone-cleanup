...
'[BorderImage](../QtQuick.BorderImage/index.html)' shows off the various scaling modes of the [BorderImage](../QtQuick.BorderImage/index.html) item by setting its horizontalTileMode and verticalTileMode properties.

'Image' shows off the various fill modes of the Image item.

'Shadows' shows how to create a drop shadow effect for a rectangular item using a [BorderImage](../QtQuick.BorderImage/index.html):
...
'[AnimatedSprite](../QtQuick.AnimatedSprite/index.html)' shows how to display a simple animation using an [AnimatedSprite](../QtQuick.AnimatedSprite/index.html) object:
...
'[SpriteSequence](../QtQuick.SpriteSequence/index.html)' demonstrates using a sprite sequence to draw an animated and interactive bear. The [SpriteSequence](../QtQuick.SpriteSequence/index.html) defines 5 different sprites. The bear is initially in a 'still' state:
