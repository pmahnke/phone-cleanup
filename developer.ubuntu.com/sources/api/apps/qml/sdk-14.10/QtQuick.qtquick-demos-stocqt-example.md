...
*StocQt* demonstrates various QML and [Qt Quick](../QtQuick.qtquick-index/index.html) features such as displaying custom components and downloading data from the internet.
