...
This example demonstrates a couple of visual effects that you can perform with shaders in [Qt Quick](../QtQuick.qtquick-index/index.html).

ShaderEffects typically operate on other types, using a [ShaderEffectSource](../QtQuick.ShaderEffectSource/index.html)
...
ShaderEffects can also have a custom vertext shader. Setting the mesh property on [ShaderEffect](../QtQuick.ShaderEffect/index.html) provides more vertices for you to manipulate, enabling many effects.
