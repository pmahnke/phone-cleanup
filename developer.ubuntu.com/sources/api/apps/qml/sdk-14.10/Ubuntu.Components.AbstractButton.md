...
This class defines the behavior of the button: it defines the [MouseArea](../QtQuick.MouseArea/index.html) and the states. All components deriving from this class support haptic feedback out of the box.
