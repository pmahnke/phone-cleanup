...
<tbody>
<tr class="odd">
<td><p><span id="page-prop"></span><span class="name">page</span> : <span class="type"><a href="../QtQuick.Item/index.html">Item</a></span></p></td>
</tr>
</tbody>
</table>

The contents of the page. Use a [Page](../Ubuntu.Components.Page/index.html) or a Loader that loads an external [Page](../Ubuntu.Components.Page/index.html).
