...
-   ****[align](index.html#align-prop)**** : int` (preliminary)`
-   ****[flickableItem](index.html#flickableItem-prop)**** : Flickable` (preliminary)`
...
This property holds the flickable item (Flickable, [ListView](../QtQuick.ListView/index.html) or [GridView](../QtQuick.GridView/index.html)) the Scrollbar is attached to.
