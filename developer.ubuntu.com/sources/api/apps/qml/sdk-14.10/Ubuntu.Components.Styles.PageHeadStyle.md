...
-   ****[separatorBottomSource](index.html#separatorBottomSource-prop)**** : url
-   ****[separatorSource](index.html#separatorSource-prop)**** : url
-   ****[textColor](index.html#textColor-prop)**** : color
...
The source of an additional image attached to the bottom of the separator. The contents of the [MainView](../Ubuntu.Components.MainView/index.html) will be drawn on top of the separator bottom image.
...
The source of the image that separates the header from the contents of a [MainView](../Ubuntu.Components.MainView/index.html). The separator will be drawn over the contents.
