...
<tr class="even">
<td>Inherited By:</td>
<td><p><a href="../Ubuntu.Components.ActionItem/index.html">ActionItem</a>, <a href="https://developer.ubuntu.com/api/apps/qml/sdk-14.10/Ubuntu.Components.AppHeader/">AppHeader</a>, <a href="../Ubuntu.Components.Pickers.DatePicker/index.html">DatePicker</a>, <a href="../Ubuntu.Components.Pickers.Dialer/index.html">Dialer</a>, <a href="../Ubuntu.Components.Pickers.DialerHand/index.html">DialerHand</a>, <a href="https://developer.ubuntu.com/api/apps/qml/sdk-14.10/Ubuntu.Components.PageTreeNode/">PageTreeNode</a>, <a href="../Ubuntu.Components.Pickers.Picker/index.html">Picker</a>, <a href="../Ubuntu.Components.PullToRefresh/index.html">PullToRefresh</a>, <a href="../Ubuntu.Components.Scrollbar/index.html">Scrollbar</a>, <a href="../Ubuntu.Components.Slider/index.html">Slider</a>, <a href="../Ubuntu.Components.TabBar/index.html">TabBar</a>, and <a href="../Ubuntu.Components.TextArea/index.html">TextArea</a>.</p></td>
</tr>
</tbody>
</table>
...
In order to make an Item stylable by the theme, it is enough to make the Item inherit from StyledItem and set its [style](index.html#style-prop) property to be the result of the appropriate call to Theme.createStyleComponent().
...
The Component set on [style](index.html#style-prop) is instantiated and placed below everything else that the Item contains.
