...
The Spectrum Analyzer example shows how the [Qt Multimedia](../QtMultimedia.qtmultimedia-index/index.html) module can be used to record and then play back an audio stream.

![](https://developer.ubuntu.com/static/devportal_uploaded/99d4a5a2-9f12-480d-b4d7-31a2e67d0c0b-api/apps/qml/sdk-14.10/qtmultimedia-spectrum-example/images/spectrum-demo.png)
