...
A BorderImage breaks a source image, specified using the [source](index.html#source-prop) property, into 9 regions, as shown below:
...
**See also** [Image](../QtQuick.Image/index.html) and [AnimatedImage](../QtQuick.AnimatedImage/index.html).
