...
*Photo Surface* demonstrates how to handle dragging, rotation and pinch zooming within the same item using a [PinchArea](../QtQuick.PinchArea/index.html) containing a [MouseArea](../QtQuick.MouseArea/index.html).
