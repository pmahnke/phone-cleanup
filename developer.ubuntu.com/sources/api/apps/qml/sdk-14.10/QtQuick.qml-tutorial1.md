...
First, we need to import the types that we need for this example. Most QML files will import the built-in QML types (like [Rectangle](../QtQuick.Rectangle/index.html), [Image](../QtQuick.Image/index.html), ...) that come with Qt, using:
...
We add a [Text](../QtQuick.Text/index.html) type as a child of the root Rectangle type that displays the text 'Hello world!'.
