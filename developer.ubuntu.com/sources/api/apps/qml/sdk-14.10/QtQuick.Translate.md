...
The following example moves the Y axis of the [Rectangle](../QtQuick.Rectangle/index.html) items while still allowing the [Row](../QtQuick.Row/index.html) to lay the items out as if they had not been transformed:
