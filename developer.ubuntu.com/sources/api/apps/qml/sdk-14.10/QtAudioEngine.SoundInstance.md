...
There are two ways to create SoundInstance objects. You can obtain it by calling newInstance method of a [Sound](../QtAudioEngine.Sound/index.html):
...
Or alternatively, you can explicitly define SoundInstance outside of [AudioEngine](../QtAudioEngine.AudioEngine/index.html) for easier qml bindings:
...
<tbody>
<tr class="odd">
<td><p><span id="stateChanged-signal"></span><span class="name">stateChanged</span>(<span class="type"><a href="index.html#state-prop">state</a></span>)</p></td>
</tr>
</tbody>
</table>
