...
Like [Map](../QtLocation.Map/index.html) and [GeocodeModel](../QtLocation.GeocodeModel/index.html), all the data for a RouteModel to work comes from a services plugin. This is contained in the [plugin](index.html#plugin-prop) property, and this must be set before the RouteModel can do any useful work.

Once the plugin is set, create a [RouteQuery](../QtLocation.RouteQuery/index.html) with the appropriate waypoints and other settings, and set the RouteModel's [query](index.html#query-prop) property. If [autoUpdate](index.html#autoUpdate-prop) is enabled, the update will being automatically. Otherwise, the [update](index.html#update-method) method may be used. By default, [autoUpdate](index.html#autoUpdate-prop) is disabled.

The data stored and returned in the RouteModel consists of [Route](../QtLocation.Route/index.html) objects, as a list with the role name "routeData". See the documentation for [Route](../QtLocation.Route/index.html) for further details on its structure and contents.
