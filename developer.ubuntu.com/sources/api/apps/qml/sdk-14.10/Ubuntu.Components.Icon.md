...
-   ****[keyColor](index.html#keyColor-prop)**** : color
...
Icons can also be colorized. Setting the [color](index.html#color-prop) property will make all pixels with the [keyColor](index.html#keyColor-prop) (by default \#808080) colored.
...
The color that all pixels that originally are of color [keyColor](index.html#keyColor-prop) should take.
...
<tbody>
<tr class="odd">
<td><p><span id="keyColor-prop"></span><span class="name">keyColor</span> : <span class="type"><a href="index.html#color-prop">color</a></span></p></td>
</tr>
</tbody>
</table>
