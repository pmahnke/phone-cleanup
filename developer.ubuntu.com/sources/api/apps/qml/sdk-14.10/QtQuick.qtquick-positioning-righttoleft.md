...
(This applies to the [Text](../QtQuick.Text/index.html), [TextInput](../QtQuick.TextInput/index.html) and [TextEdit](../QtQuick.TextEdit/index.html) types.)
...
(This applies to the [Row](../QtQuick.Row/index.html), [Grid](../QtQuick.Grid/index.html), [Flow](../QtQuick.Flow/index.html), [ListView](../QtQuick.ListView/index.html) and [GridView](../QtQuick.GridView/index.html) types.)
...
(This applies to [Image](../QtQuick.Image/index.html), [BorderImage](../QtQuick.BorderImage/index.html) and [AnimatedImage](../QtQuick.AnimatedImage/index.html) types.)
