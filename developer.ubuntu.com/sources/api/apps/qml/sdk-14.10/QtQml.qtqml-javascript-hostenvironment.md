...
-   Global code is run in a reduced scope.
    ...
    This restriction exists as the QML environment is not yet fully established. To run code after the environment setup has completed, refer to [Running JavaScript at Startup](../QtQml.qtqml-javascript-expressions/index.html#running-javascript-at-startup).
