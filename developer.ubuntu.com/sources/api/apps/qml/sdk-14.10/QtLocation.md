...
The Category type represents a category that a [Place](../QtLocation.Place/index.html) can be associated with.

[CategoryModel](../QtLocation.CategoryModel/index.html)  
The CategoryModel type provides a model of the categories supported by a [Plugin](../QtLocation.Plugin/index.html).
...
The ContactDetails type holds contact details for a [Place](../QtLocation.Place/index.html).
...
The ExtendedAttributes type holds additional data about a [Place](../QtLocation.Place/index.html).
...
The PluginParameter type describes a parameter to a [Plugin](../QtLocation.Plugin/index.html).
...
Provides access to reviews of a [Place](../QtLocation.Place/index.html).
...
The RouteQuery type is used to provide query parameters to a [RouteModel](../QtLocation.RouteModel/index.html).

[RouteSegment](../QtLocation.RouteSegment/index.html)  
...
The User type identifies a user who contributed a particular [Place](../QtLocation.Place/index.html) content item.
