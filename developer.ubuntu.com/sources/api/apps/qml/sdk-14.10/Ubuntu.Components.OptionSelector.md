...
-   ****[colourImage](index.html#colourImage-prop)**** : bool` (preliminary)`
-   ****[containerHeight](index.html#containerHeight-prop)**** : real` (preliminary)`
-   ****[currentlyExpanded](index.html#currentlyExpanded-prop)**** : bool
-   ****[delegate](index.html#delegate-prop)**** : Component` (preliminary)`
-   ****[expanded](index.html#expanded-prop)**** : bool` (preliminary)`
-   ****[itemHeight](index.html#itemHeight-prop)**** : real
-   ****[model](index.html#model-prop)**** : var` (preliminary)`
-   ****[multiSelection](index.html#multiSelection-prop)**** : bool` (preliminary)`
