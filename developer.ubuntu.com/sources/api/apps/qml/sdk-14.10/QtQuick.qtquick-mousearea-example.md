...
This is an example of the [MouseArea](../QtQuick.MouseArea/index.html) type in QML
...
This example shows you how to respond to clicks and drags with a [MouseArea](../QtQuick.MouseArea/index.html).
...
The [MouseArea](../QtQuick.MouseArea/index.html) can also be used to drag items around. By setting the parameters of the drag property, the target item will be dragged around if the user starts to drag within the [MouseArea](../QtQuick.MouseArea/index.html).
