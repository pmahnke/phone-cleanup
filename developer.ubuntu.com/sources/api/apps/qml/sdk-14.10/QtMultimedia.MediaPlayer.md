...
You can use MediaPlayer by itself to play audio content (like [Audio](../QtMultimedia.Audio/index.html)), or you can use it in conjunction with a [VideoOutput](../QtMultimedia.VideoOutput/index.html) for rendering video.
