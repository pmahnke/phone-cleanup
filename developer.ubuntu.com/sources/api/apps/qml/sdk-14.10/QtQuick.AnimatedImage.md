...
The AnimatedImage type extends the features of the [Image](../QtQuick.Image/index.html) type, providing a way to play animations stored as images containing a series of frames, such as those stored in GIF files.
...
**See also** [BorderImage](../QtQuick.BorderImage/index.html) and [Image](../QtQuick.Image/index.html).
