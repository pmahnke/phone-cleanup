...
To set such a parameter, declare a PluginParameter inside a [Plugin](../QtLocation.Plugin/index.html) object, and give it [name](index.html#name-prop) and [value](index.html#value-prop) properties. A list of valid parameter names for each plugin is available from the [plugin reference pages](../QtLocation.qtlocation-index/index.html#plugin-references-and-parameters).
