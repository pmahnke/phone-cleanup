...
The name can potentially be localized. The language is dependent on the entity that sets it, typically this is the [Plugin](../QtLocation.Plugin/index.html). The [Plugin::locales](../QtLocation.Plugin/index.html#locales-prop) property defines what language is used.
