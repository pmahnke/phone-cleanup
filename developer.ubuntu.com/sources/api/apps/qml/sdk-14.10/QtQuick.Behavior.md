...
If a [state change](../QtQuick.qtquick-statesanimations-states/index.html) has a [Transition](../QtQuick.Transition/index.html) that matches the same property as a Behavior, the [Transition](../QtQuick.Transition/index.html) animation overrides the Behavior for that state change. For general advice on using Behaviors to animate state changes, see [Using Qt Quick Behaviors with States](../QtQuick.qtquick-statesanimations-behaviors/index.html).

**See also** [Animation and Transitions in Qt Quick](../QtQuick.qtquick-statesanimations-animations/index.html), Behavior example, and Qt QML.
