...
The ExtendedAttributes type is a map of [PlaceAttributes](../QtLocation.PlaceAttribute/index.html). To access attributes in the map use the [keys()](index.html#keys-method) method to get the list of keys stored in the map and use the `[]` operator to access the [PlaceAttribute](../QtLocation.PlaceAttribute/index.html) items.

The following are standard keys that are defined by the API. [Plugin](../QtLocation.Plugin/index.html) implementations are free to define additional keys. Custom keys should be qualified by a unique prefix to avoid clashes.
...
**Note:** ExtendedAttributes instances are only ever used in the context of [Place](../QtLocation.Place/index.html)s. It is not possible to create an ExtendedAttributes instance directly or re-assign a [Place](../QtLocation.Place/index.html)'s ExtendedAttributes property. Modification of ExtendedAttributes can only be accomplished via Javascript.

The following example shows how to access all [PlaceAttributes](../QtLocation.PlaceAttribute/index.html) and print them to the console:
...
**See also** [PlaceAttribute](../QtLocation.PlaceAttribute/index.html) and QQmlPropertyMap.
