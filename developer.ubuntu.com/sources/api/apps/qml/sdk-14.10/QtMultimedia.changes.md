...
-   Expanded QML API
-   In addition to the [Video](../QtMultimedia.Video/index.html) QML type, there is now the option of using [MediaPlayer](../QtMultimedia.MediaPlayer/index.html) and [VideoOutput](../QtMultimedia.VideoOutput/index.html) together
