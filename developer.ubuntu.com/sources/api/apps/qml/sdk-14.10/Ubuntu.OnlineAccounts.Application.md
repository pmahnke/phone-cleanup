...
-   string ****[serviceUsage](index.html#serviceUsage-method)****(Service *service*)

<span id="details"></span>
Detailed Description
--------------------

The Application element represents an application using online accounts. Currently, instances of this object cannot be created directly, but are instantiated by the [ApplicationModel](../Ubuntu.OnlineAccounts.ApplicationModel/index.html) element.
