...
Specific drag types can be obtained using the [colorData](index.html#colorData-prop), [html](index.html#html-prop), [text](https://developer.ubuntu.com/api/apps/qml/sdk-14.10/QtQuick.text/), and [urls](index.html#urls-prop) properties.
