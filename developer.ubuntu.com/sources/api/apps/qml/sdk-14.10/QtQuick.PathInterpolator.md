...
Typical usage of [PathInterpolator](index.html) is to set the progress (often via a [NumberAnimation](../QtQuick.NumberAnimation/index.html)), and read the corresponding values for x, y, and angle (often via bindings to these values).
