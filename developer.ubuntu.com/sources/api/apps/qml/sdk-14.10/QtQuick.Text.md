...
Note that for a single line of text, the size of the text is the area of the text. In this common case, all alignments are equivalent. If you want the text to be, say, centered in its parent, then you will need to either modify the Item::anchors, or set [horizontalAlignment](index.html#horizontalAlignment-prop) to Text.AlignHCenter and bind the width to that of the parent.
...
<tbody>
<tr class="odd">
<td><p><span id="linkColor-prop"></span><span class="name">linkColor</span> : <span class="type"><a href="index.html#color-prop">color</a></span></p></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td><p><span id="styleColor-prop"></span><span class="name">styleColor</span> : <span class="type"><a href="index.html#color-prop">color</a></span></p></td>
</tr>
</tbody>
</table>
