...
-   ****[running](index.html#running-prop)**** : bool` (preliminary)`

<span id="details"></span>
Detailed Description
--------------------

Note: for time consuming JavaScript operations use [WorkerScript](../QtQml.WorkerScript/index.html), otherwise no UI interaction will be possible and the ActicityIndicator animation will freeze.
