...
A layout block is a component embedding several layout definitions and items to be laid out. It is typically defined by the [Layouts](../Ubuntu.Layouts.Layouts/index.html) component.
...
![](https://developer.ubuntu.com/static/devportal_uploaded/0faaffc9-f6ca-45d8-881b-fe96132fd9c1-api/apps/qml/sdk-14.10/ubuntu-layouts1/images/sample-layout.png)
...
A container can be any item, however it is preferable to use positioners or [QtQuick](http://qt-project.org/doc/qt-5.3/qtquick-module.html) layout elements whenever possible.

As next step let's create some layouts.

<a href="../UbuntuUserInterfaceToolkit.ubuntu-layouts2/index.html" class="nextPage">Layouts - The first conditional layout</a>
