...
[Audio](../QtMultimedia.Audio/index.html) is an easy way to add audio playback to a Qt Quick scene. Qt Multimedia provides properties for control, methods (functions) and signals.
...
Much of the getting / setting of [Audio](../QtMultimedia.Audio/index.html) parameters is done through properties. These include
...
[Camera](../QtMultimedia.Camera/index.html) enables still image and video capture using QML. It has a number of properties that help setting it up.

The details of using a [Camera](../QtMultimedia.Camera/index.html) are described in further depth in the [Camera Overview](../QtMultimedia.cameraoverview/index.html) and in the corresponding reference documentation.

<span id="video"></span>
### Video

Adding video playback, with sound, to a Qt Quick scene is also easy. The process is very similar to that of Audio above, in fact [Video](../QtMultimedia.Video/index.html) shares many of the property names, methods and signals. Here is the equivalent sample code to implement video playback in a scene
...
Most of the differences will obviously be about video control and information. There are many properties associated with [Video](../QtMultimedia.Video/index.html), most of them deal with meta-data, control of the video media and aspects of presentation.

<span id="soundeffect"></span>
### SoundEffect

[SoundEffect](../QtMultimedia.SoundEffect/index.html) provides a way to play short sound effects, like in video games. Multiple sound effect instances can be played simultaneously. You should use [Audio](../QtMultimedia.Audio/index.html) for music playback.
...
For a complete description of this type, see [SoundEffect](../QtMultimedia.SoundEffect/index.html)
