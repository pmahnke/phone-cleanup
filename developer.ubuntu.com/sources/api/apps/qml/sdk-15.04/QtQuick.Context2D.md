...
-   ****[canvas](index.html#canvas-prop)**** : QtQuick::Canvas
-   ****[fillRule](index.html#fillRule-prop)**** : enumeration
-   ****[fillStyle](index.html#fillStyle-prop)**** : variant
-   ****[font](index.html#font-prop)**** : string
-   ****[globalAlpha](index.html#globalAlpha-prop)**** : real
-   ****[globalCompositeOperation](index.html#globalCompositeOperation-prop)**** : string
-   ****[lineCap](index.html#lineCap-prop)**** : string
-   ****[lineJoin](index.html#lineJoin-prop)**** : string
-   ****[lineWidth](index.html#lineWidth-prop)**** : real
-   ****[miterLimit](index.html#miterLimit-prop)**** : real
-   ****[shadowBlur](index.html#shadowBlur-prop)**** : real
-   ****[shadowColor](index.html#shadowColor-prop)**** : string
-   ****[shadowOffsetX](index.html#shadowOffsetX-prop)**** : qreal
-   ****[shadowOffsetY](index.html#shadowOffsetY-prop)**** : qreal
-   ****[strokeStyle](index.html#strokeStyle-prop)**** : variant
-   ****[textAlign](index.html#textAlign-prop)**** : string
-   ****[textBaseline](index.html#textBaseline-prop)**** : string

<span id="methods"></span>
Methods
-------

-   object ****[arc](index.html#arc-method)****(real *x*, real *y*, real *radius*, real *startAngle*, real *endAngle*, bool *anticlockwise*)
-   object ****[arcTo](index.html#arcTo-method)****(real *x1*, real *y1*, real *x2*, real *y2*, real *radius*)
-   object ****[beginPath](index.html#beginPath-method)****()
-   object ****[bezierCurveTo](index.html#bezierCurveTo-method)****(real *cp1x*, real *cp1y*, real *cp2x*, real *cp2y*, real *x*, real *y*)
-   object ****[clearRect](index.html#clearRect-method)****(real *x*, real *y*, real *w*, real *h*)
-   object ****[clip](index.html#clip-method)****()
-   object ****[closePath](index.html#closePath-method)****()
-   object ****[createConicalGradient](index.html#createConicalGradient-method)****(real *x*, real *y*, real *angle*)
-   CanvasImageData ****[createImageData](index.html#createImageData-method-3)****(Url *imageUrl*)
-   CanvasImageData ****[createImageData](index.html#createImageData-method-2)****(CanvasImageData *imageData*)
-   CanvasImageData ****[createImageData](index.html#createImageData-method)****(real *sw*, real *sh*)
-   object ****[createLinearGradient](index.html#createLinearGradient-method)****(real *x0*, real *y0*, real *x1*, real *y1*)
-   variant ****[createPattern](index.html#createPattern-method-2)****(Image *image*, string *repetition*)
-   variant ****[createPattern](index.html#createPattern-method)****(color *color*, enumeration *patternMode*)
-   object ****[createRadialGradient](index.html#createRadialGradient-method)****(real *x0*, real *y0*, real *r0*, real *x1*, real *y1*, real *r1*)
-   ****[drawImage](index.html#drawImage-method-3)****(variant *image*, real *sx*, real *sy*, real *sw*, real *sh*, real *dx*, real *dy*, real *dw*, real *dh*)
-   ****[drawImage](index.html#drawImage-method-2)****(variant *image*, real *dx*, real *dy*, real *dw*, real *dh*)
-   ****[drawImage](index.html#drawImage-method)****(variant *image*, real *dx*, real *dy*)
-   object ****[ellipse](index.html#ellipse-method)****(real *x*, real *y*, real *w*, real *h*)
-   object ****[fill](index.html#fill-method)****()
-   object ****[fillRect](index.html#fillRect-method)****(real *x*, real *y*, real *w*, real *h*)
-   object ****[fillText](index.html#fillText-method)****(text, x, y)
-   CanvasImageData ****[getImageData](index.html#getImageData-method)****(real *sx*, real *sy*, real *sw*, real *sh*)
-   object ****[isPointInPath](index.html#isPointInPath-method)****(real *x*, real *y*)
-   object ****[lineTo](index.html#lineTo-method)****(real *x*, real *y*)
-   object ****[measureText](index.html#measureText-method)****(text)
-   object ****[moveTo](index.html#moveTo-method)****(real *x*, real *y*)
-   object ****[putImageData](index.html#putImageData-method)****(CanvasImageData *imageData*, real *dx*, real *dy*, real *dirtyX*, real *dirtyY*, real *dirtyWidth*, real *dirtyHeight*)
-   object ****[quadraticCurveTo](index.html#quadraticCurveTo-method)****(real *cpx*, real *cpy*, real *x*, real *y*)
-   object ****[rect](index.html#rect-method)****(real *x*, real *y*, real *w*, real *h*)
-   object ****[reset](index.html#reset-method)****()
-   object ****[resetTransform](index.html#resetTransform-method)****()
-   object ****[restore](index.html#restore-method)****()
-   object ****[rotate](index.html#rotate-method)****(real *angle*)
-   object ****[roundedRect](index.html#roundedRect-method)****(real *x*, real *y*, real *w*, real *h*, real *xRadius*, real *yRadius*)
-   object ****[save](index.html#save-method)****()
-   object ****[scale](index.html#scale-method)****(real *x*, real *y*)
-   object ****[setTransform](index.html#setTransform-method)****(real *a*, real *b*, real *c*, real *d*, real *e*, real *f*)
-   object ****[shear](index.html#shear-method)****(real *sh*, real *sv*)
-   object ****[stroke](index.html#stroke-method)****()
-   object ****[strokeRect](index.html#strokeRect-method)****(real *x*, real *y*, real *w*, real *h*)
-   object ****[strokeText](index.html#strokeText-method)****(text, x, y)
-   object ****[text](index.html#text-method)****(string *text*, real *x*, real *y*)
-   object ****[transform](index.html#transform-method)****(real *a*, real *b*, real *c*, real *d*, real *e*, real *f*)
-   object ****[translate](index.html#translate-method)****(real *x*, real *y*)
...
![](https://developer.ubuntu.com/static/devportal_uploaded/78436edb-a5a4-4066-a27c-d745b8787180-api/apps/qml/sdk-15.04/QtQuick.Context2D/images/qml-item-canvas-context.gif)
...
<tbody>
<tr class="odd">
<td><p><span id="canvas-prop"></span><span class="name">canvas</span> : <span class="type"><a href="../QtQuick.Canvas/index.html">QtQuick::Canvas</a></span></p></td>
</tr>
</tbody>
</table>
...
**See also** [fillStyle](index.html#fillStyle-prop).
...
Holds the current style used for filling shapes. The style can be either a string containing a CSS color, a [CanvasGradient](../QtQuick.CanvasGradient/index.html) or CanvasPattern object. Invalid values are ignored. This property accepts several color syntaxes:
...
If the `fillStyle` or [strokeStyle](index.html#strokeStyle-prop) is assigned many times in a loop, the last Qt.rgba() syntax should be chosen, as it has the best performance, because it's already a valid QColor value, does not need to be parsed everytime.

The default value is '\#000000'.

**See also** [createLinearGradient()](index.html#createLinearGradient-method), [createRadialGradient()](index.html#createRadialGradient-method), [createPattern()](index.html#createPattern-method), and [strokeStyle](index.html#strokeStyle-prop).
...
**See also** [shadowOffsetY](index.html#shadowOffsetY-prop).
...
**See also** [shadowOffsetX](index.html#shadowOffsetX-prop).
...
Holds the current color or style to use for the lines around shapes, The style can be either a string containing a CSS color, a [CanvasGradient](../QtQuick.CanvasGradient/index.html) or CanvasPattern object. Invalid values are ignored.

The default value is '\#000000'.

**See also** [createLinearGradient()](index.html#createLinearGradient-method), [createRadialGradient()](index.html#createRadialGradient-method), [createPattern()](index.html#createPattern-method), and [fillStyle](index.html#fillStyle-prop).
...
![](https://developer.ubuntu.com/static/devportal_uploaded/f05597e7-e9b5-4294-95aa-dc351e3a612c-api/apps/qml/sdk-15.04/QtQuick.Context2D/images/qml-item-canvas-startAngle.png)
...
**See also** [arcTo](index.html#arcTo-method) and [W3C's 2D Context Standard for arc()](http://www.w3.org/TR/2dcontext/#dom-context-2d-arc).
...
-   Call the [beginPath()](index.html#beginPath-method) method to set a new path.
-   Call the [moveTo](index.html#moveTo-method)(`x`, `y`) method to set your starting position on the canvas at the point (`x`, `y`).
...
![](https://developer.ubuntu.com/static/devportal_uploaded/050d8f4e-fd9f-47b0-a281-ddcaa0f60d13-api/apps/qml/sdk-15.04/QtQuick.Context2D/images/qml-item-canvas-arcTo.png)

**See also** [arc](index.html#arc-method) and [W3C's 2D Context Standard for arcTo()](http://www.w3.org/TR/2dcontext/#dom-context-2d-arcto).
...
![](https://developer.ubuntu.com/static/devportal_uploaded/5e1719c0-b936-4667-b2af-558af6131972-api/apps/qml/sdk-15.04/QtQuick.Context2D/images/qml-item-canvas-bezierCurveTo.png)
...
![](https://developer.ubuntu.com/static/devportal_uploaded/3208ff5c-b3a6-4f99-8afc-b7fa869d53e2-api/apps/qml/sdk-15.04/QtQuick.Context2D/images/qml-item-canvas-clip-complex.png)

**See also** [beginPath()](index.html#beginPath-method), [closePath()](index.html#closePath-method), [stroke()](index.html#stroke-method), [fill()](index.html#fill-method), and [W3C 2d context standard for clip](http://www.w3.org/TR/2dcontext/#dom-context-2d-clip).
...
Returns a [CanvasGradient](../QtQuick.CanvasGradient/index.html) object that represents a conical gradient that interpolate colors counter-clockwise around a center point (`x`, `y`) with start angle `angle` in units of radians.

**See also** [CanvasGradient::addColorStop()](../QtQuick.CanvasGradient/index.html#addColorStop-method), [createLinearGradient()](index.html#createLinearGradient-method), [createRadialGradient()](index.html#createRadialGradient-method), [createPattern()](index.html#createPattern-method), [fillStyle](index.html#fillStyle-prop), and [strokeStyle](index.html#strokeStyle-prop).
...
<tbody>
<tr class="odd">
<td><p><span id="createImageData-method-3"></span><span class="type"><a href="../QtQuick.CanvasImageData/index.html">CanvasImageData</a></span> <span class="name">createImageData</span>(<span class="type">Url</span> <em>imageUrl</em>)</p></td>
</tr>
</tbody>
</table>

Creates a [CanvasImageData](../QtQuick.CanvasImageData/index.html) object with the given image loaded from *imageUrl*.

**Note:** The *imageUrl* must be already loaded before this function call, otherwise an empty [CanvasImageData](../QtQuick.CanvasImageData/index.html) obect will be returned.

**See also** [Canvas::loadImage()](../QtQuick.Canvas/index.html#loadImage-method), [QtQuick::Canvas::unloadImage()](../QtQuick.Canvas/index.html#unloadImage-method), and [QtQuick::Canvas::isImageLoaded](../QtQuick.Canvas/index.html#isImageLoaded-method).
...
<tbody>
<tr class="odd">
<td><p><span id="createImageData-method-2"></span><span class="type"><a href="../QtQuick.CanvasImageData/index.html">CanvasImageData</a></span> <span class="name">createImageData</span>(<span class="type"><a href="../QtQuick.CanvasImageData/index.html">CanvasImageData</a></span> <em>imageData</em>)</p></td>
</tr>
</tbody>
</table>

Creates a [CanvasImageData](../QtQuick.CanvasImageData/index.html) object with the same dimensions as the argument.
...
<tbody>
<tr class="odd">
<td><p><span id="createImageData-method"></span><span class="type"><a href="../QtQuick.CanvasImageData/index.html">CanvasImageData</a></span> <span class="name">createImageData</span>(<span class="type">real</span> <em>sw</em>, <span class="type">real</span> <em>sh</em>)</p></td>
</tr>
</tbody>
</table>

Creates a [CanvasImageData](../QtQuick.CanvasImageData/index.html) object with the given dimensions(*sw*, *sh*).
...
Returns a [CanvasGradient](../QtQuick.CanvasGradient/index.html) object that represents a linear gradient that transitions the color along a line between the start point (*x0*, *y0*) and the end point (*x1*, *y1*).
...
**See also** [CanvasGradient::addColorStop()](../QtQuick.CanvasGradient/index.html#addColorStop-method), [createRadialGradient()](index.html#createRadialGradient-method), [createConicalGradient()](index.html#createConicalGradient-method), [createPattern()](index.html#createPattern-method), [fillStyle](index.html#fillStyle-prop), and [strokeStyle](index.html#strokeStyle-prop).
...
<tbody>
<tr class="odd">
<td><p><span id="createPattern-method-2"></span><span class="type">variant</span> <span class="name">createPattern</span>(<span class="type"><a href="../QtQuick.Image/index.html">Image</a></span> <em>image</em>, <span class="type">string</span> <em>repetition</em>)</p></td>
</tr>
</tbody>
</table>
...
The *image* parameter must be a valid Image item, a valid [CanvasImageData](../QtQuick.CanvasImageData/index.html) object or loaded image url, if there is no image data, throws an INVALID\_STATE\_ERR exception.
...
**See also** [strokeStyle](index.html#strokeStyle-prop) and [fillStyle](index.html#fillStyle-prop).
...
Returns a [CanvasGradient](../QtQuick.CanvasGradient/index.html) object that represents a radial gradient that paints along the cone given by the start circle with origin (x0, y0) and radius r0, and the end circle with origin (x1, y1) and radius r1.

**See also** [CanvasGradient::addColorStop()](../QtQuick.CanvasGradient/index.html#addColorStop-method), [createLinearGradient()](index.html#createLinearGradient-method), [createConicalGradient()](index.html#createConicalGradient-method), [createPattern()](index.html#createPattern-method), [fillStyle](index.html#fillStyle-prop), and [strokeStyle](index.html#strokeStyle-prop).
...
Note: The *image* type can be an Image or Canvas item, an image url or a [CanvasImageData](../QtQuick.CanvasImageData/index.html) object. When given as Image item, if the image isn't fully loaded, this method draws nothing. When given as url string, the image should be loaded by calling Canvas item's [Canvas::loadImage()](../QtQuick.Canvas/index.html#loadImage-method) method first. This image been drawing is subject to the current context clip path, even the given `image` is a [CanvasImageData](../QtQuick.CanvasImageData/index.html) object.

**See also** [CanvasImageData](../QtQuick.CanvasImageData/index.html), [Image](https://developer.ubuntu.com/api/apps/qml/sdk-15.04/QtQuick.imageelements/#image), [Canvas::loadImage()](../QtQuick.Canvas/index.html#loadImage-method), [Canvas::isImageLoaded](../QtQuick.Canvas/index.html#isImageLoaded-method), [Canvas::imageLoaded](../QtQuick.Canvas/index.html#imageLoaded-signal), and [W3C 2d context standard for drawImage](http://www.w3.org/TR/2dcontext/#dom-context-2d-drawimage).
...
Note: The *image* type can be an Image item, an image url or a [CanvasImageData](../QtQuick.CanvasImageData/index.html) object. When given as Image item, if the image isn't fully loaded, this method draws nothing. When given as url string, the image should be loaded by calling Canvas item's [Canvas::loadImage()](../QtQuick.Canvas/index.html#loadImage-method) method first. This image been drawing is subject to the current context clip path, even the given `image` is a [CanvasImageData](../QtQuick.CanvasImageData/index.html) object.
...
Draws the given *image* on the canvas at position (*dx*, *dy*). Note: The *image* type can be an Image item, an image url or a [CanvasImageData](../QtQuick.CanvasImageData/index.html) object. When given as Image item, if the image isn't fully loaded, this method draws nothing. When given as url string, the image should be loaded by calling Canvas item's [Canvas::loadImage()](../QtQuick.Canvas/index.html#loadImage-method) method first. This image been drawing is subject to the current context clip path, even the given `image` is a [CanvasImageData](../QtQuick.CanvasImageData/index.html) object.
...
**See also** [W3C 2d context standard for fill](http://www.w3.org/TR/2dcontext/#dom-context-2d-fill) and [fillStyle](index.html#fillStyle-prop).
...
Paint the specified rectangular area using the [fillStyle](index.html#fillStyle-prop).
...
<tbody>
<tr class="odd">
<td><p><span id="fillText-method"></span><span class="type">object</span> <span class="name">fillText</span>(<span class="type"><a href="index.html#text-method">text</a></span>, <span class="type">x</span>, <span class="type">y</span>)</p></td>
</tr>
</tbody>
</table>
...
**See also** [font](index.html#font-prop), [textAlign](index.html#textAlign-prop), [textBaseline](index.html#textBaseline-prop), and [strokeText](index.html#strokeText-method).
...
<tbody>
<tr class="odd">
<td><p><span id="getImageData-method"></span><span class="type"><a href="../QtQuick.CanvasImageData/index.html">CanvasImageData</a></span> <span class="name">getImageData</span>(<span class="type">real</span> <em>sx</em>, <span class="type">real</span> <em>sy</em>, <span class="type">real</span> <em>sw</em>, <span class="type">real</span> <em>sh</em>)</p></td>
</tr>
</tbody>
</table>

Returns an [CanvasImageData](../QtQuick.CanvasImageData/index.html) object containing the image data for the given rectangle of the canvas.
...
<tbody>
<tr class="odd">
<td><p><span id="measureText-method"></span><span class="type">object</span> <span class="name">measureText</span>(<span class="type"><a href="index.html#text-method">text</a></span>)</p></td>
</tr>
</tbody>
</table>
...
Reset the transformation matrix to the default value (equivalent to calling [setTransform](index.html#setTransform-method)(`1`, `0`, `0`, `1`, `0`, `0`)).

**See also** [transform()](index.html#transform-method), [setTransform()](index.html#setTransform-method), and [reset()](index.html#reset-method).
...
![](https://developer.ubuntu.com/static/devportal_uploaded/9c0a6923-5346-4229-83ee-ccb117cf0823-api/apps/qml/sdk-15.04/QtQuick.Context2D/images/qml-item-canvas-rotate.png)

The rotation transformation matrix is as follows:

![](https://developer.ubuntu.com/static/devportal_uploaded/70ec893e-8576-4b2a-8658-9b5967b5d759-api/apps/qml/sdk-15.04/QtQuick.Context2D/images/qml-item-canvas-math-rotate.png)
...
-   [strokeStyle](index.html#strokeStyle-prop)
-   [fillStyle](index.html#fillStyle-prop)
-   [fillRule](index.html#fillRule-prop)
-   [globalAlpha](index.html#globalAlpha-prop)
-   [lineWidth](index.html#lineWidth-prop)
-   [lineCap](index.html#lineCap-prop)
-   [lineJoin](index.html#lineJoin-prop)
-   [miterLimit](index.html#miterLimit-prop)
-   [shadowOffsetX](index.html#shadowOffsetX-prop)
-   [shadowOffsetY](index.html#shadowOffsetY-prop)
-   [shadowBlur](index.html#shadowBlur-prop)
-   [shadowColor](index.html#shadowColor-prop)
-   [globalCompositeOperation](index.html#globalCompositeOperation-prop)
-   [font](index.html#font-prop)
-   [textAlign](index.html#textAlign-prop)
-   [textBaseline](index.html#textBaseline-prop)

The current path is NOT part of the drawing state. The path can be reset by invoking the [beginPath()](index.html#beginPath-method) method.
...
![](https://developer.ubuntu.com/static/devportal_uploaded/4219e147-16f3-4147-b1f1-2b74f2a6e78c-api/apps/qml/sdk-15.04/QtQuick.Context2D/images/qml-item-canvas-scale.png)
...
![](https://developer.ubuntu.com/static/devportal_uploaded/a80138bf-c841-43f3-b8ed-efee6e19d05b-api/apps/qml/sdk-15.04/QtQuick.Context2D/images/qml-item-canvas-math.png)

where:

-   `a` is the scale factor in the horizontal (x) direction

    ![](https://developer.ubuntu.com/static/devportal_uploaded/185c87bf-183f-4d14-b3a1-500909efccea-api/apps/qml/sdk-15.04/QtQuick.Context2D/images/qml-item-canvas-scalex.png)

-   `c` is the skew factor in the x direction

    ![](https://developer.ubuntu.com/static/devportal_uploaded/92eff7a1-2ec7-42d6-9690-2480e0b155fb-api/apps/qml/sdk-15.04/QtQuick.Context2D/images/qml-item-canvas-skewx.png)

-   `e` is the translation in the x direction

    ![](https://developer.ubuntu.com/static/devportal_uploaded/43658c8e-a579-48f8-b2c6-5bf834357894-api/apps/qml/sdk-15.04/QtQuick.Context2D/images/qml-item-canvas-translate.png)

-   `b` is the skew factor in the y (vertical) direction

    ![](https://developer.ubuntu.com/static/devportal_uploaded/78185b1b-405d-4c59-90a3-cf08cd552313-api/apps/qml/sdk-15.04/QtQuick.Context2D/images/qml-item-canvas-skewy.png)

-   `d` is the scale factor in the y direction

    ![](https://developer.ubuntu.com/static/devportal_uploaded/c731f7dc-2439-4302-b9bd-2c662633c233-api/apps/qml/sdk-15.04/QtQuick.Context2D/images/qml-item-canvas-scaley.png)

-   `f` is the translation in the y direction

    ![](https://developer.ubuntu.com/static/devportal_uploaded/00890db8-f0ed-4db3-9f7d-f6c8e8643ae1-api/apps/qml/sdk-15.04/QtQuick.Context2D/images/qml-item-canvas-translatey.png)
...
**See also** [transform()](index.html#transform-method).
...
**See also** [strokeStyle](index.html#strokeStyle-prop).
...
Stroke the specified rectangle's path using the [strokeStyle](index.html#strokeStyle-prop), [lineWidth](index.html#lineWidth-prop), [lineJoin](index.html#lineJoin-prop), and (if appropriate) [miterLimit](index.html#miterLimit-prop) attributes.

**See also** [strokeStyle](index.html#strokeStyle-prop), [lineWidth](index.html#lineWidth-prop), [lineJoin](index.html#lineJoin-prop), and [miterLimit](index.html#miterLimit-prop).
...
<tbody>
<tr class="odd">
<td><p><span id="strokeText-method"></span><span class="type">object</span> <span class="name">strokeText</span>(<span class="type"><a href="index.html#text-method">text</a></span>, <span class="type">x</span>, <span class="type">y</span>)</p></td>
</tr>
</tbody>
</table>
...
**See also** [font](index.html#font-prop), [textAlign](index.html#textAlign-prop), [textBaseline](index.html#textBaseline-prop), and [fillText](index.html#fillText-method).
...
This method is very similar to [setTransform()](index.html#setTransform-method), but instead of replacing the old transform matrix, this method applies the given tranform matrix to the current matrix by multiplying to it.

The [setTransform](index.html#setTransform-method)(a, b, c, d, e, f) method actually resets the current transform to the identity matrix, and then invokes the transform(a, b, c, d, e, f) method with the same arguments.

**See also** [setTransform()](index.html#setTransform-method).
