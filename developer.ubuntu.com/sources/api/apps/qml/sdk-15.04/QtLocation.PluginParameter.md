...
-   ****[value](index.html#value-prop)**** : QVariant
...
To set such a parameter, declare a [PluginParameter](index.html) inside a [Plugin](../QtLocation.location-places-qml/index.html#plugin) object, and give it [name](index.html#name-prop) and [value](index.html#value-prop) properties. A list of valid parameter names for each plugin is available from the [plugin reference pages](../QtLocation.qtlocation-index/index.html#plugin-references-and-parameters).

<span id="example-usage"></span>
### Example Usage

The following example shows an instantiation of the [Nokia](../QtLocation.location-plugin-nokia/index.html) plugin with a mapping API *app\_id* and *token* pair specific to the application.
