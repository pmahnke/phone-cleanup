...
-   [Image](https://developer.ubuntu.com/api/apps/qml/sdk-15.04/QtQuick.imageelements/#image), [ShaderEffectSource](../QtQuick.ShaderEffectSource/index.html) -&gt; sampler2D - Origin is in the top-left corner, and the color values are premultiplied.
