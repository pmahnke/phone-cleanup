...
The following code examples are a small part of the `map` component in the [Map Viewer (QML)](https://developer.ubuntu.com/api/apps/qml/sdk-15.04/QtLocation.mapviewer/) example. The snippets demonstrate the declaration of the [GeocodeModel](../QtLocation.GeocodeModel/index.html) component.
...
For more information on the example see the [Map Viewer (QML)](https://developer.ubuntu.com/api/apps/qml/sdk-15.04/QtLocation.mapviewer/) example.
...
The above snippets are taken from the [Map Viewer (QML)](https://developer.ubuntu.com/api/apps/qml/sdk-15.04/QtLocation.mapviewer/) example.
