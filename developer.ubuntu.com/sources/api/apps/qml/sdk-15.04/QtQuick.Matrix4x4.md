...
-   ****[matrix](index.html#matrix-prop)**** : QMatrix4x4

<span id="details"></span>
Detailed Description
--------------------

The Matrix4x4 type provides a way to apply a transformation to an [Item](../QtQuick.Item/index.html) through a 4x4 matrix.
...
4x4-matrix which will be used in the tranformation of an [Item](../QtQuick.Item/index.html)
