...
-   ****[mobile](index.html#mobile-prop)**** : bool
-   ****[name](index.html#name-prop)**** : string
-   ****[night](index.html#night-prop)**** : bool
...
This includes the map type's [name](index.html#name-prop) and [description](index.html#description-prop), the [style](index.html#style-prop) and a flag to indicate if the map type is optimized for mobile devices ([mobile](index.html#mobile-prop)).
