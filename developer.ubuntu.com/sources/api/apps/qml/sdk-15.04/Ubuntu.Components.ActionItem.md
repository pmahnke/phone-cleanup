...
<tr class="odd">
<td>Inherited By:</td>
<td><p><a href="../Ubuntu.Components.AbstractButton/index.html">AbstractButton</a>, <a href="../Ubuntu.Components.TextField/index.html">TextField</a>, and <a href="../Ubuntu.Components.ToolbarButton/index.html">ToolbarButton</a>.</p></td>
</tr>
</tbody>
</table>
...
See [ToolbarItems](https://developer.ubuntu.com/api/apps/qml/sdk-15.04/Ubuntu.Components.ToolbarItems/) for examples of how to use [ToolbarButton](../Ubuntu.Components.ToolbarButton/index.html) or other ActionItems in a toolbar.
...
The [Action](../Ubuntu.Components.Action/index.html) associated with this [ActionItem](index.html). If action is set, the values of the Action properties are copied to the values of the [ActionItem](index.html) properties.
