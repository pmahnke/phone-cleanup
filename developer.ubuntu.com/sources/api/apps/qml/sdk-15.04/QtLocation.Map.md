...
The current Map plugin in use is contained in the [plugin](../QtLocation.location-places-qml/index.html#plugin) property of the Map item. In order to display any image in a Map item, you will need to set this property. See the [Plugin](../QtLocation.location-places-qml/index.html#plugin) type for a description of how to retrieve an appropriate plugin for use.
...
![](https://developer.ubuntu.com/static/devportal_uploaded/eb39cbe4-aaa7-43db-885e-49cf7448e40a-api/apps/qml/sdk-15.04/QtLocation.Map/images/api-map.png)
...
The maximum zoom level is defined by the [plugin](../QtLocation.location-places-qml/index.html#plugin) used. If a plugin supporting mapping is not set, -1.0 is returned.
...
The minimum zoom level is defined by the [plugin](../QtLocation.location-places-qml/index.html#plugin) used. If a plugin supporting mapping is not set, -1.0 is returned.
