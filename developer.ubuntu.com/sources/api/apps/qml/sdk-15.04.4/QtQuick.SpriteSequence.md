...
[SpriteSequence](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.4/QtQuick.imageelements/#spritesequence) renders and controls a list of animations defined by [Sprite](../QtQuick.Sprite/index.html) types.
...
This function causes the [SpriteSequence](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.4/QtQuick.imageelements/#spritesequence) to jump to the specified sprite immediately, intermediate sprites are not played. The *sprite* argument is the name of the sprite you wish to jump to.
