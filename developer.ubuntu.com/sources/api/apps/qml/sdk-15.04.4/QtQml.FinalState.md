...
A final state is used to communicate that (part of) a [StateMachine](../QtQml.StateMachine/index.html) has finished its work. When a final top-level state is entered, the state machine's [finished](../QtQml.State/index.html#finished-signal)() signal is emitted. In general, when a final substate (a child of a State) is entered, the parent state's [finished](../QtQml.State/index.html#finished-signal)() signal is emitted. [FinalState](index.html) is part of [The Declarative State Machine Framework](../QtQml.qmlstatemachine/index.html).
