...
![](https://developer.ubuntu.com/static/devportal_uploaded/676c0438-1b3f-42ad-a953-e04ef1c98e8b-api/apps/qml/sdk-15.04.4/qtquick-modelviewsdata-modelview/images/modelview-overview.png)
...
-   [GridView](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.4/QtQuick.draganddrop/#gridview) - arranges items in a grid within the available space
...
![](https://developer.ubuntu.com/static/devportal_uploaded/263f36a2-c978-4a7d-8a44-443945da13a3-api/apps/qml/sdk-15.04.4/qtquick-modelviewsdata-modelview/images/listview-decorations.png)
...
![](https://developer.ubuntu.com/static/devportal_uploaded/11c96e8a-70ac-4075-9740-f6ff4beb5be7-api/apps/qml/sdk-15.04.4/qtquick-modelviewsdata-modelview/images/listview-section.png)
...
![](https://developer.ubuntu.com/static/devportal_uploaded/b6426eae-954f-40f3-a965-4581ecbc9f81-api/apps/qml/sdk-15.04.4/qtquick-modelviewsdata-modelview/images/listview-setup.png)

<span id="accessing-views-and-models-from-delegates"></span>
### Accessing Views and Models from Delegates

The list view to which the delegate is bound is accessible from the delegate through the `ListView.view` property. Likewise, the [GridView](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.4/QtQuick.draganddrop/#gridview) `GridView.view` is available to delegates. The corresponding model and its properties, therefore, are available through `ListView.view.model`. In addition, any defined signals or methods in the model are also accessible.
...
The [RSS News demo](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.4/QtQuick.demos-rssnews/) shows how [XmlListModel](index.html#xmllistmodel) can be used to display an RSS feed.
...
![](https://developer.ubuntu.com/static/devportal_uploaded/dc7ee47b-9187-467a-a90b-5d2f53b38e12-api/apps/qml/sdk-15.04.4/qtquick-modelviewsdata-modelview/images/repeater-index.png)
