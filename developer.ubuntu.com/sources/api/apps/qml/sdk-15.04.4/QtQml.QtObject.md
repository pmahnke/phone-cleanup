...
-   ****[objectName](index.html#objectName-prop)**** : string

<span id="details"></span>
Detailed Description
--------------------

The [QtObject](index.html) type is a non-visual element which contains only the [objectName](index.html#objectName-prop) property.
