...
![](https://developer.ubuntu.com/static/devportal_uploaded/41d95fcb-1d28-47d3-9faa-2cf2d67100fa-api/apps/qml/sdk-15.04.4/qtquick-animation-example/images/qml-animations-example.png)
...
*PathAnimation* animates an image along a bezier curve using a [PathAnimation](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.4/QtQuick.animation/#pathanimation).
...
*PathInterpolator* animates an image along the same bezier curve, using a [PathInterpolator](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.4/QtQuick.animation/#pathinterpolator) instead.
