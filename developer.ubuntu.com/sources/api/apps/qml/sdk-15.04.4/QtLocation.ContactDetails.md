...
-   variant ****[keys](../../sdk-15.04.1/QtLocation.ContactDetails/index.html#keys-method)****()

<span id="details"></span>
Detailed Description
--------------------

The [ContactDetails](../../sdk-15.04.1/QtLocation.ContactDetails/index.html) type is a map of [ContactDetail](../../sdk-15.04.1/QtLocation.ContactDetail/index.html) objects. To access contact details in the map use the [keys()](../../sdk-15.04.1/QtLocation.ContactDetails/index.html#keys-method) method to get the list of keys stored in the map and then use the `[]` operator to access the [ContactDetail](../../sdk-15.04.1/QtLocation.ContactDetail/index.html) items.

The following keys are defined in the API. [Plugin](../../sdk-15.04.1/QtLocation.location-places-qml/index.html#plugin) implementations are free to define additional keys.
...
[ContactDetails](../../sdk-15.04.1/QtLocation.ContactDetails/index.html) instances are only ever used in the context of [Places](../../sdk-15.04.1/QtLocation.location-cpp-qml/index.html#place). It is not possible to create a [ContactDetails](../../sdk-15.04.1/QtLocation.ContactDetails/index.html) instance directly or re-assign [ContactDetails](../../sdk-15.04.1/QtLocation.ContactDetails/index.html) instances to [Places](../../sdk-15.04.1/QtLocation.location-cpp-qml/index.html#place). Modification of [ContactDetails](../../sdk-15.04.1/QtLocation.ContactDetails/index.html) can only be accomplished via Javascript.

<span id="examples"></span>
Examples
--------

The following example shows how to access all [ContactDetails](../../sdk-15.04.1/QtLocation.ContactDetail/index.html) and print them to the console:
