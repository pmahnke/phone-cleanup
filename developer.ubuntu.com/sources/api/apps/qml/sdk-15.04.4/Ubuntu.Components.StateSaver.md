...
List of properties to be serialized, separated with commas. Properties must be writable and can only be [QML base types](../../sdk-15.04/QtQml.qtqml-typesystem-basictypes/index.html).
