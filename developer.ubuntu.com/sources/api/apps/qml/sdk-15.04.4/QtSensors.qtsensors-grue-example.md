...
![](https://developer.ubuntu.com/static/devportal_uploaded/6ed05ce9-ae04-462e-8fdf-cc8ba076ef8a-api/apps/qml/sdk-15.04.4/qtsensors-grue-example/images/qtsensors-examples-grue.png)
...
-   [Grue Sensor Definition](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.4/QtSensors.grue/#grue-sensor-definition)
-   [Grue Sensor Implementation](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.4/QtSensors.grue/#grue-sensor-implementation)

The sensor can now be used by a C++ application, even if the application does not have access to the definition.

-   [Grue Sensor Console Application](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.4/QtSensors.grue/#grue-sensor-console-application)

To make the sensor available to a QML application an import must be created.

-   [Grue Sensor QML Import](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.4/QtSensors.grue/#grue-sensor-qml-import)
-   [Grue Sensor QML Application](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.4/QtSensors.grue/#grue-sensor-qml-application)
