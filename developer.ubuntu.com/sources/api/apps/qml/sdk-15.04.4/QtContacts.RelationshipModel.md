...
There are two ways of accessing the relationship data: through model by using views and delegates, or alternatively via [relationships](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.4/QtContacts.qtcontacts-overview/#relationships) list property.
