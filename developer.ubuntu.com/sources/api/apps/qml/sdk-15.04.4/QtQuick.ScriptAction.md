...
-   ****[scriptName](index.html#scriptName-prop)**** : string
...
When used as part of a Transition, you can also target a specific [StateChangeScript](../QtQuick.StateChangeScript/index.html) to run using the `scriptName` property.
...
**See also** [StateChangeScript](../QtQuick.StateChangeScript/index.html).
...
This property holds the name of the [StateChangeScript](../QtQuick.StateChangeScript/index.html) to run.
