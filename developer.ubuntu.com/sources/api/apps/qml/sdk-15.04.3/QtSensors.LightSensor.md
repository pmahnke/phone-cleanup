...
-   ****[fieldOfView](index.html#fieldOfView-prop)**** : qreal

<span id="details"></span>
Detailed Description
--------------------

The [LightSensor](index.html) element reports on light levels using LUX.

This element wraps the QLightSensor class. Please see the documentation for QLightSensor for details.

**See also** [LightReading](../QtSensors.LightReading/index.html).
