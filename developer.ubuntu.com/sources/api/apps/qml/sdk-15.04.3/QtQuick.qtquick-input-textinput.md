...
<span id="details"></span> <span id="text-visual-types"></span>
Text Visual Types
-----------------

Qt Quick provides several types to display text onto the screen. The [Text](../QtQuick.qtquick-releasenotes/index.html#text) type will display formatted text onto the screen, the [TextEdit](../QtQuick.TextEdit/index.html) type will place a multiline line edit onto the screen, and the [TextInput](../QtQuick.TextInput/index.html) will place a single editable line field onto the screen.
...
The *validator* types enforce the type and format of [TextInput](../QtQuick.TextInput/index.html) objects.
