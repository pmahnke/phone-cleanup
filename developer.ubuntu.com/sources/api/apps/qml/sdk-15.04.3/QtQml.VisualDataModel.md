...
The [VisualDataModel](index.html) type encapsulates a model and the delegate that will be instantiated for items in a model.
...
**See also** [QtQml.Models::DelegateModel](../QtQml.DelegateModel/index.html).
