...
![](https://developer.ubuntu.com/static/devportal_uploaded/6c20866f-11fb-445b-b6ab-4a377d236a19-api/apps/qml/sdk-15.04.3/qtquick-modelviewsdata-modelview/images/modelview-overview.png)
...
-   [GridView](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.3/QtQuick.draganddrop/#gridview) - arranges items in a grid within the available space
...
![](https://developer.ubuntu.com/static/devportal_uploaded/e8e4f231-b2ba-4514-86f0-9b71ba91fdf1-api/apps/qml/sdk-15.04.3/qtquick-modelviewsdata-modelview/images/listview-decorations.png)
...
![](https://developer.ubuntu.com/static/devportal_uploaded/e0fecc46-4f4d-4b2c-9256-0bc76d390ffc-api/apps/qml/sdk-15.04.3/qtquick-modelviewsdata-modelview/images/listview-section.png)
...
![](https://developer.ubuntu.com/static/devportal_uploaded/01b14767-3196-4fae-a7b7-23387463aee1-api/apps/qml/sdk-15.04.3/qtquick-modelviewsdata-modelview/images/listview-setup.png)

<span id="accessing-views-and-models-from-delegates"></span>
### Accessing Views and Models from Delegates

The list view to which the delegate is bound is accessible from the delegate through the `ListView.view` property. Likewise, the [GridView](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.3/QtQuick.draganddrop/#gridview) `GridView.view` is available to delegates. The corresponding model and its properties, therefore, are available through `ListView.view.model`. In addition, any defined signals or methods in the model are also accessible.
...
The [RSS News demo](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.3/QtQuick.demos-rssnews/) shows how [XmlListModel](index.html#xmllistmodel) can be used to display an RSS feed.
...
![](https://developer.ubuntu.com/static/devportal_uploaded/f9f60dd8-4e74-4b68-80d7-e163ce6f9ade-api/apps/qml/sdk-15.04.3/qtquick-modelviewsdata-modelview/images/repeater-index.png)
