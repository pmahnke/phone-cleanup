...
Specifies whether the width of the column should fill the available space of the [AdaptivePageLayout](../Ubuntu.Components.AdaptivePageLayout/index.html) column or not. Defaults to *false*.
...
Specifies the preferred width of the column when the layout is initialized. Defaults to 0. [AdaptivePageLayout](../Ubuntu.Components.AdaptivePageLayout/index.html) clamps the given value between [minimumWidth](index.html#minimumWidth-prop) and [maximumWidth](index.html#maximumWidth-prop). The value must be set if the [fillWidth](index.html#fillWidth-prop) and [minimumWidth](index.html#minimumWidth-prop) are not set.
