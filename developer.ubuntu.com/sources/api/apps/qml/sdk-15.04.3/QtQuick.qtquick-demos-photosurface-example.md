...
![](https://developer.ubuntu.com/static/devportal_uploaded/08310f18-18e5-404e-8ae7-dff681c192a7-api/apps/qml/sdk-15.04.3/qtquick-demos-photosurface-example/images/qtquick-demo-photosurface-small.png)
...
Users can also click the file dialog icon to open the file dialog. We use an [Image](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.3/QtQuick.imageelements/#image) QML type to display the icon. Inside the [Image](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.3/QtQuick.imageelements/#image) type, we use a [MouseArea](../QtQuick.MouseArea/index.html) with the `onClicked` signal handler to call the `fileDialog.open()` function:
