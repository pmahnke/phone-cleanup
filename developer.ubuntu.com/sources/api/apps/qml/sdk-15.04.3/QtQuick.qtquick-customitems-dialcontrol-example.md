...
This example shows how to create a dial-type control. It combines [Image](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.3/QtQuick.imageelements/#image) elements with [Rotation](../QtQuick.Rotation/index.html) transforms and [SpringAnimation](../QtQuick.SpringAnimation/index.html) behaviors to produce an interactive speedometer-type dial.
