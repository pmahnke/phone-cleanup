...
![](https://developer.ubuntu.com/static/devportal_uploaded/89897787-3f61-45fd-bf65-542f2b0a3797-api/apps/qml/sdk-15.04.1/qtquick-modelviewsdata-modelview/images/modelview-overview.png)
...
-   [GridView](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.1/QtQuick.draganddrop/#gridview) - arranges items in a grid within the available space
...
![](https://developer.ubuntu.com/static/devportal_uploaded/4d825ace-fd96-42cb-ba31-c30476917139-api/apps/qml/sdk-15.04.1/qtquick-modelviewsdata-modelview/images/listview-decorations.png)
...
![](https://developer.ubuntu.com/static/devportal_uploaded/37085e14-7180-43d1-b6c7-0fc86ae26e43-api/apps/qml/sdk-15.04.1/qtquick-modelviewsdata-modelview/images/listview-section.png)
...
![](https://developer.ubuntu.com/static/devportal_uploaded/0cfac28e-fb0d-48e3-9cbd-dd528fe19b1d-api/apps/qml/sdk-15.04.1/qtquick-modelviewsdata-modelview/images/listview-setup.png)

<span id="accessing-views-and-models-from-delegates"></span>
### Accessing Views and Models from Delegates

The list view to which the delegate is bound is accessible from the delegate through the `ListView.view` property. Likewise, the [GridView](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.1/QtQuick.draganddrop/#gridview) `GridView.view` is available to delegates. The corresponding model and its properties, therefore, are available through `ListView.view.model`. In addition, any defined signals or methods in the model are also accessible.
...
The [RSS News demo](https://developer.ubuntu.com/api/apps/qml/sdk-15.04.1/QtQuick.demos-rssnews/) shows how [XmlListModel](index.html#xmllistmodel) can be used to display an RSS feed.
...
![](https://developer.ubuntu.com/static/devportal_uploaded/5adf2704-e36d-41a1-baf0-a9c073a6001e-api/apps/qml/sdk-15.04.1/qtquick-modelviewsdata-modelview/images/repeater-index.png)
