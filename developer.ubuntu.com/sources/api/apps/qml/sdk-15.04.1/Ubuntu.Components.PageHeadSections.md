...
These sections will be shown in the bottom part of the header. This component does not need to be instantiated by the developer, it is automatically part of [PageHeadConfiguration](../Ubuntu.Components.PageHeadConfiguration/index.html).

See also [Sections](../Ubuntu.Components.Sections/index.html).
...
The index of the currently selected section in [model](index.html#model-prop).
