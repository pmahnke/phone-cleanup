...
-   bool ****[move](index.html#move-method-2)****(dir, fileName)
-   bool ****[move](index.html#move-method)****(dir)
-   string ****[toDataURI](index.html#toDataURI-method)****()

<span id="details"></span>
Detailed Description
--------------------

A [ContentItem](index.html) is an item that can be imported or exported from a [ContentPeer](../Ubuntu.Content.ContentPeer/index.html)
