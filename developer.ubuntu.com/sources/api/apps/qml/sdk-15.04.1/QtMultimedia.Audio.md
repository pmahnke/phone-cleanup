...
This signal is emitted when the playlist loading failed. [error](index.html#error-signal) and [errorString](index.html#errorString-prop) can be checked for more information on the failure.
