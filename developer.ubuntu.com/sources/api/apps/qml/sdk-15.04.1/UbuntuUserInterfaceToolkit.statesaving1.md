...
<span id="details"></span> <span id="application-name"></span>
Application name
----------------
...
Having these preconditions, we can deduct that [MainView::applicationName](../Ubuntu.Components.MainView/index.html#applicationName-prop) property is one of the properties which cannot be serialized.
...
<a href="../UbuntuUserInterfaceToolkit.statesaving2/index.html" class="nextPage">Saving multiple properties</a>
