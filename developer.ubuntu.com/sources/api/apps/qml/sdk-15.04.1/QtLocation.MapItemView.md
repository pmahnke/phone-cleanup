...
-   ****[autoFitViewport](index.html#autoFitViewport-prop)**** : Component
...
The [MapItemView](index.html) is used to populate Map with MapItems from a model. The [MapItemView](index.html) type only makes sense when contained in a Map, meaning that it has no standalone presentation.

<span id="example-usage"></span>
### Example Usage

This example demonstrates how to use the MapViewItem object to display a [route](../QtLocation.Route/index.html) on a [map](../QtLocation.Map/index.html):
