...
-   ****[numberOfSlots](index.html#numberOfSlots-prop)**** : int
...
Set this to override the default delegate button that shows the actions in the [ActionBar](index.html). Uses the defaultDelegate of [ActionBarStyle](../Ubuntu.Components.Styles.ActionBarStyle/index.html) by default.
