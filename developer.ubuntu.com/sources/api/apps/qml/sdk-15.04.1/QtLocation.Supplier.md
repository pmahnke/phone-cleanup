...
-   ****[supplier](index.html#supplier-prop)**** : QPlaceSupplier
-   ****[supplierId](index.html#supplierId-prop)**** : string
...
**See also** [ImageModel](../QtLocation.ImageModel/index.html), [ReviewModel](../QtLocation.ReviewModel/index.html), and [EditorialModel](../QtLocation.EditorialModel/index.html).
...
The name can potentially be localized. The language is dependent on the entity that sets it, typically this is the [Plugin](../QtLocation.location-places-qml/index.html#plugin). The [Plugin::locales](../QtLocation.Plugin/index.html#locales-prop) property defines what language is used.
