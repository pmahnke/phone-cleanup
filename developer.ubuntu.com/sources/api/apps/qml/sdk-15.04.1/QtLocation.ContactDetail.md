...
The [ContactDetail](index.html) provides a single detail on how one could contact a [Place](../QtLocation.location-cpp-qml/index.html#place). The [ContactDetail](index.html) consists of a [label](index.html#label-prop), which is a localized string describing the contact method, and a [value](index.html#value-prop) representing the actual contact detail.
...
The label can potentially be localized. The language is dependent on the entity that sets it, typically this is the [Plugin](../QtLocation.location-places-qml/index.html#plugin). The [Plugin::locales](../QtLocation.Plugin/index.html#locales-prop) property defines what language is used.
