...
List elements are defined inside [ListModel](../QtQml.ListModel/index.html) definitions, and represent items in a list that will be displayed using ListView or Repeater items.
...
**See also** [ListModel](../QtQml.ListModel/index.html).
