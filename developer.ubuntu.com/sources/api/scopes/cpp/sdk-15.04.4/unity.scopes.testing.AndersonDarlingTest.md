...
Implements the Anderson-Darling test for normality for the case of empirical mean and variance. [More...](index.html#details)
...
|                                                                                                                 |     |                                                                                    |          |     |     |
|-----------------------------------------------------------------------------------------------------------------|-----|------------------------------------------------------------------------------------|----------|-----|-----|
| unity::scopes::testing::AndersonDarlingTest::Result unity::scopes::testing::AndersonDarlingTest::for\_normality | (   | const <a href="../unity.scopes.testing.Sample/index.html" class="el">Sample</a> &  | *sample* | )   |     |
