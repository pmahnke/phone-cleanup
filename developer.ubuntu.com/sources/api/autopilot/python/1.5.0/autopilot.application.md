...
[ClickApplicationLauncher](../autopilot.application.ClickApplicationLauncher/index.html)  
Fixture to manage launching a Click application.A class that knows how to launch an application with a certain typ

[NormalApplicationLauncher](../autopilot.application.NormalApplicationLauncher/index.html)  
Fixture to manage launching an application.A class that knows how to launch an application with a certain typ

[UpstartApplicationLauncher](../autopilot.application.UpstartApplicationLauncher/index.html)  
