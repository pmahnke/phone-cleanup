 ...
 *class* `scope_harness.``ScopeHarness`<a href="index.html#scope_harness.ScopeHarness" class="headerlink" title="Permalink to this definition"></a>  
 ...
 *static* `new_from_pre_existing_config`(*(str)arg1*) → ScopeHarness :<a href="index.html#scope_harness.ScopeHarness.new_from_pre_existing_config" class="headerlink" title="Permalink to this definition"></a>  
Creates ScopeHarness instance from scope runtime configuration files in given directory

 *static* `new_from_scope_list`(*(Parameters)arg1*) → ScopeHarness :<a href="index.html#scope_harness.ScopeHarness.new_from_scope_list" class="headerlink" title="Permalink to this definition"></a>  
 ...
 *static* `new_from_system`() → ScopeHarness :<a href="index.html#scope_harness.ScopeHarness.new_from_system" class="headerlink" title="Permalink to this definition"></a>  
