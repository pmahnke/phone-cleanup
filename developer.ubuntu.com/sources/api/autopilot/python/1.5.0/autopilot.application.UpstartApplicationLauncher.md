 ...
 *class* `autopilot.application.``UpstartApplicationLauncher`(*case\_addDetail=None*, *emulator\_base=None*, *dbus\_bus='session'*)<a href="index.html#autopilot.application.UpstartApplicationLauncher" class="headerlink" title="Permalink to this definition"></a>  
...
| Parameters: | -   **case\_addDetail** – addDetail method to use.                                                                          
 ...
 `launch`(*app\_id*, *app\_uris=\[\]*)<a href="index.html#autopilot.application.UpstartApplicationLauncher.launch" class="headerlink" title="Permalink to this definition"></a>  
...
<!-- -->
 ...
 `autopilot.application.``get_application_launcher_wrapper`(*app\_path*)<a href="index.html#autopilot.application.get_application_launcher_wrapper" class="headerlink" title="Permalink to this definition"></a>  
