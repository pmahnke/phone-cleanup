...
The tutorial section <a href="../tutorial-advanced_autopilot/index.html#custom-proxy-classes" class="reference internal"><em>Writing Custom Proxy Classes</em></a> for further details on using ‘CustomEmulatorBase’ to write custom proxy classes.

### Elements

[ProxyBase](../autopilot.introspection.ProxyBase/index.html)  
